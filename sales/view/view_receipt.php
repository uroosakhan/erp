...
label_cells(_("Cheque #"), $receipt['cheque_no'], "class='tableheader2'");
label_cells(_("Customer Bank"), $receipt['text_1'], "class='tableheader2'");
label_cells(_("Customer Bank Branch"), $receipt['text_2'], "class='tableheader2'");
label_cells(_("Deposit Slip No."), $receipt['text_3'], "class='tableheader2'");
end_row();
