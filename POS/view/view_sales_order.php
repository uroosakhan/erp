...
label_row(_("Shipping Charges"), price_format($_SESSION['View']->freight_cost),
...
$total_discount = $_SESSION['View']->total_discount;
label_row(_("Total Discount"), $total_discount.' %', "align=right colspan=6",
	"nowrap align=right", 1);
...
$total_disc = $sub_tot / 100 * $_SESSION['View']->total_discount;

$display_total = ($sub_tot + $tax_total - $total_disc );
