...
if (isset($_POST['ProcessOrder']) && can_process()) {
    ...
    else
    {
        ...
        if ($modified) {
           ...
           // header("/sales_modify_entry.php?");
//            header("Location: /POS/sales_modify_entry.php"); /* Redirect browser */
//            exit();
        //    header('Refresh: 5; URL=sales_modify_entry.php?AddedID=' . $trans_no);
...
function handle_new_item_old($stk_id)
{
...
//
//
//    <div class="col-sm-2" style="background-color:; float: right; width: 9%; height: 200px; ">
//<table class="table">
//  <thead>
//
//  </thead>
...
//
//
//<button type="button" class="btn btn"><a href="sales_modify_entry.php">modify</a></button>
//
//</th>
//
//    </tr>
...
if ($customer_error == "") {
    ...
    //echo '<div style="float: left; margin-left: 400px; margin-top: 50px; width: 900px;">';
    start_table(TABLESTYLE, "width=50%", 10);
    echo "<tr><td>";
...
//$date = get_dhabba_current_date(get_company_pref('shop_hrs'));
