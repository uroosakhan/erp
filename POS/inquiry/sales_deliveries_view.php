...
include($path_to_root . "/POS/includes/sales_ui.inc");
include($path_to_root . "/POS/includes/sales_db.inc");
...
//------------------------------------------------------------------------------------------------
$sql = get_sql_for_sales_deliveries_view_pos($selected_customer, $selected_stock_item);
