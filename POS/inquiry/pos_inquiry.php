...
function display_customer_summary($customer_record)
{
    ...
    $th = array(_("No of Transactions"), _("Gross Amount"), _("Discount"), _("After Disc. Amt."), _("GST"), _("Net Amount"), _("Average / Trans"));
    table_header($th);
    ...
    amount_cell1($customer_record['GstAmt']);
    amount_cell1($customer_record['total_amount']-$customer_record['t_discount']+$customer_record['GstAmt']);
    $Net_Amount = $customer_record['total_amount'] - $customer_record['t_discount']+$customer_record['GstAmt'];
...
function Sum_after_Discount($row)
{
    $totl = $row['total'] - $row['TotalDiscount'];
    $_SESSION['TotalAfterDiscount'] += $totl;
    return $totl;
}
function Sum_Gst($row)
{
    $_SESSION['h_text4'] += $row['h_text4'];
    return $row['h_text4'];
}
...
$cols = array(
 ...
 if($_SESSION["wa_current_user"]->can_access('SA_VOIDTRANSACTION') ) 
 {
	...
	_("After Disc. Amt.") => array('align'=>'right', 'type'=>'amount', 'fun' => 'Sum_after_Discount'),
	_("GST") => array( 'align'=>'right', 'type'=>'amount', 'fun' => 'Sum_Gst'),
	_("Net Amount") => array('align'=>'right', 'type'=>'amount', 'fun' => 'Sum_NetAmount'),
    // _("Alloc") => array('align'=>'right','type'=>'amount'),
...
else
{
	...
	_("Gross Amount") => array('align'=>'right', 'type'=>'amount', 'fun' => 'Sum_GrossAmount'),
	_("Discount") => array('align'=>'right', 'type'=>'amount', 'fun' => 'Sum_Discount'),
	_("After Disc. Amt.") => array('insert'=>true,'align'=>'right', 'type'=>'amount', 'fun' => 'Sum_after_Discount'),
	_("GST") => array('insert'=>true, 'align'=>'right', 'type'=>'amount', 'fun' => 'Sum_Gst'),
	_("Net Amount") => array('align'=>'right', 'type'=>'amount', 'fun' => 'Sum_NetAmount'),
// 	_("Alloc") => array('align'=>'right','type'=>'amount'),
	_("Cash Tendered") => array('align'=>'right','type'=>'amount'),
    _("Cash Return") => array('align'=>'right','type'=>'amount'),
