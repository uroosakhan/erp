...
if ($dept != ALL_TEXT)
$sql .= "AND ".TB_PREF."presence.emp_dept =".db_escape($dept);
$sql .= "AND ".TB_PREF."presence.date >=".db_escape($fromdate);
$sql .= "AND ".TB_PREF."presence.date<=".db_escape($todate);
...
if ($month_name == ALL_TEXT)
  ...
  if ($employee == ALL_TEXT)
	...
	$headers = array(_('Employee'), _('Name'), _('Department Name'), _(''), _('Date'), _(''), _('Remarks'), _(''), _(''), _('Present'), _(''), _(''), _(''));
