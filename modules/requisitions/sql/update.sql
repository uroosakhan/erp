...
CREATE TABLE 0_requisition_details (
	...
	requisition_id			BIGINT references requisitions,
	item_code				varchar(20),
	supplier_id				BIGINT references suppliers,
	lpo_id					BIGINT default 0,
	order_quantity			BIGINT default 0 not null,
...
delimiter $$
CREATE FUNCTION 0_generate_po_items(po_id BIGINT, s_id BIGINT) RETURNS varchar(50) deterministic
BEGIN
	DECLARE u_gl decimal(5,0);
