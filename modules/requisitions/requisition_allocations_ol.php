...
$th = array(_(""),_("Req#"), _("Point of Use"), _("Request Date"),_("Item Code"), _("Item Name"),
...
// save also in hidden field for testing during 'Reconcile'
		check_cells(null, $name, $value, true, _('Reconcile this transaction'))/*.
...
//display_error(check_value('rec_'.$id));
...
function get_all_data_from_new_pos_inactive($supplier,$order_no)
{
	$sql =" SELECT ".TB_PREF."item_codes.item_code, ".TB_PREF."item_codes.description,
		".TB_PREF."requisition_details.requisition_id,".TB_PREF."requisition_details.requisition_detail_id, ".TB_PREF."requisition_details.quantity, ".TB_PREF."requisition_details.price,
...
//				$purpose=$myrow2['description'];
			...
			$sql = "INSERT INTO ".TB_PREF."purch_order_details (order_no, item_code, description, delivery_date, unit_price, quantity_ordered, purpose) VALUES (";
...
//            db_query($sql, "The purchase order could not be updated");
	...
	display_notification_centered(sprintf( _("Purchase Ordre Has been Added Against these Item")));
}
