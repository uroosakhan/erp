...
class hooks_requisitions extends hooks {
	...
	*/
	function install_options($app) {
		...
		switch($app->id) {
			/*case 'AP':
				$app->add_lapp_function(0, _('Requisitions Entries'), $path_to_root.'/modules/requisitions/requisitions.php',
					'SA_REQUISITIONS',	MENU_TRANSACTION);
				$app->add_lapp_function(0, _('Requisitions Allocation'), $path_to_root.'/modules/requisitions/requisition_allocations.php',
