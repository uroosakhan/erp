...
//            $Item = get_stock_master_info_purchase($stock_id);
            ...
            $invoice_no = add_supplier_OB_purchase_return($supplier_id, $date, $price);

            if(!$invoice_no)
                display_error('Could not be insert. '.$invoice_no);
            else
                display_notification("Records Successfully. ".$invoice_no);
        }
