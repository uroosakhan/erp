...
//              2 = return sales orders error.
            ...
            $Item, $comments, $trans_no, $location, $dimension_id, $description, $StockAllow, $time);

            $sql1 = "SELECT SUM(quantity*unit_price) FROM ".TB_PREF."sales_order_details WHERE order_no=$order_no AND quantity > 0";
            ...
            $Item, $customer_id, $comments,$trans_no, $location, $dimension_id, $t_price[0], $StockAllow);
            ...
            $comments, $trans_no, $location, $dimension_id, $cash_account, $t_price[0], $StockAllow);
           ...
           if($StockAllow == 1)
           {
            ...
            $sql7 = " UPDATE ".TB_PREF."gl_trans SET amount = '".-($t_price[0])."'
                    WHERE type_no = $order_no
                    AND type = ".db_escape(ST_CUSTPAYMENT)."
