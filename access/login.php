...
//	echo "<link href='$path_to_root/themes/$def_theme/login.css' rel='stylesheet' type='text/css'> \n";
	...
	echo "<body class='hold-transition login-page' style='height:0 auto;min-height:0;' id='loginscreen' $onload'>";
...
$pageWasNotRefreshed = isset($_SERVER['HTTP_CACHE_CONTROL']) && $_SERVER['HTTP_CACHE_CONTROL'] === 'max-age=0';
...
//		echo "<div id='failed' align='center'><font size='5' color='red'><b>" . _("Incorrect Password") . "<b></font></div>";
    echo"<div class='login-box-body' style='margin-top:0;'>";
      /* echo"<p class='login-box-msg'>Sign in Here</p>"; */
       ...
       if($_SESSION['isError']=='YES' && $pageWasNotRefreshed)
       {
               $style = 'border:red 1px solid;';
               echo'<div id="msg" style="text-align: center;color: red;padding-bottom: 3px;"> Invalid User name or Password for this Company.</div>';
               echo'<div id="msg" style="text-align: center;color: red;padding-bottom: 3px;"> Please Try Again</div>';
...
//	echo "<input type='text' id='user_name_entry_field' name='user_name_entry_field' tabindex='1' required>";
           echo"<div class='form-group has-feedback'>";
                echo"<input type='text' id='user_name_entry_field' name='user_name_entry_field' tabindex='1' required class='form-control' placeholder='Enter user name.' style='".$style."'>";
   ...
   //echo "<label>" . _("Password:") . "</label>";
	//echo "<input type='password' id='password' name='password' tabindex='2' required>"; 
           ...
           echo"<div class='form-group has-feedback'>";
                echo"<input type='password' id='password' name='password' tabindex='2' required class='form-control' placeholder='Enter password.' style='".$style."'>";
...
if ($AllowCompanySelectionBox) {
	...
	echo "<input type='text' id='company_login_nickname' name='company_login_nickname' tabindex='3' required class='form-control' placeholder='Enter company code.' style='".$style."' >";
...
echo'<div style="visibility:hidden;" id="idid"><div id="myProgress">
  <div id="myBar">5%</div>
</div></div>';
echo"</div>";//<!-- /.col -->
            echo"</div>";
        ...
        echo'<script>
function move() {
   var comp = document.getElementById("company_login_nickname").value;
   if(comp !="")
       {
   document.getElementById("idid").style.visibility=\'visible\';
   document.getElementById("idid").style.marginTop =\'40px\';
