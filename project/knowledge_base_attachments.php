...
//
//
//			update_kb1($selected_id,$_POST['category'], $_POST['title'], $_POST['description'], $_POST['trans_no'], $_POST['filename'], $_POST['filesize'], $_POST['filetype'], $_POST['date']);
//
//		}
//		else
//		{
...
//			{
				...
				//add_kb1($_POST['category'], $_POST['title'], $_POST['description'], $_POST['trans_no'], $_POST['filename'], $_POST['filesize'], $_POST['filetype'], date2sql($_POST['date']));
			...
			//}
	//	}
		//display_notification(_('New Kb data has been added'));
...
{
	update_kb1($selected_id, $_POST['category'], $_POST['title'], $_POST['description'],
...
function handle_delete($selected_id)
{
	...
	add_task_history($selected_id,$_POST['start_date'], $_POST['end_date'], $_POST['description'], $_POST['customer_id'],$_POST['task_type'], $_POST['call_type'],$_POST['contact_no'],$_POST['other_cust'],$_POST['status'], $_POST['user_id'],$_POST['assign_by'], $_POST['plan'],$_POST['plan1'],0,0, $_POST['remarks'], $_POST['time'], $_SESSION['wa_current_user']->user, 0, 1);
...
//	elseif ($Mode == 'ADD_ITEM' && (!isset($_FILES['filename']) || $_FILES['filename']['size'] == 0))
	...
	//else {
		...
		if ($Mode == 'ADD_ITEM')
		{
			add_kb1($_POST['category'], $_POST['title'], $_POST['description'], $_POST['trans_no'], date2sql($_POST['date']),
