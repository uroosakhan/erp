...
//}
	if ($input_error != 1)
	{
		...
		else
		{
								...
								add_task1($_POST['start_date'], $_POST['end_date'], $_POST['description'], $_POST['customer_id'], $_POST['task_type'],$_POST['call_type'],$_POST['contact_no'],$_POST['other_cust'], $_POST['status'], $_POST['user_id'],  $_POST['plan'],$_POST['plan1'],0,0, $_POST['remarks'], $_POST['time'],$_POST['priority'],$_POST['progress'],$_POST['customer_'],$_POST['amount']);
...
if ($_GET['type'] == "task" || $_GET['type'] == "cloning")
{
	...
	start_row();
		if (!@$_GET['popup'])
			customer_list_cells(_("Customer: "), 'customer_id', null, _("Select a Customer"), false, false, !@$_GET['popup']);
