...
if (!@$_GET['popup'])
{
	...
	page(_($help_context = "Task"), isset($_GET['debtor_no']), false, "", $js);
}
...
label_cell("<center> <a href=../inquiry/calender.php? style=\"color: #CC0000\">GO TO CALENDAR</a> </center>");
...
if (!@$_GET['popup'])
	...
	customer_list_cells(_("Customer:"), 'debtor_no_', null,true, true);
...
//	users_query_list_cells(_("Assign To:"), 'users_', null,true,true);
	users_query_list_cells(_("Assign By:"), 'assign_by_', null,true,true);
//}
//call_type_list_cells(_("Call Type:"), 'call_type_', null,true, false);
users_query_list_cells(_("Assign To:"), 'assign_to_', null,true, false);
...
label_cell("<center> <a href=../task.php?type=event style=\"color: #CC0000\">ADD EVENT</a> </center>");
if($_SESSION['wa_current_user']->access == 2){
...
function edit_link($row)
{
	...
	return pager_link( _("Edit"),
		"/project/task.php?type=event&$modify=" .$row['id'], ICON_EDIT);
...
function get_customer_name1($row)
{
	$sql = "SELECT name FROM ".TB_PREF."debtors_master WHERE debtor_no=".db_escape($row['debtor_no']);
...
function get_sql_for_task_inquiry($from_date,$to_date,$debtor_no,$assign_by,$description_,$assign_to_,$remarks)
{
...
//	}
	if ($assign_to_ != '')
	{
		$sql .= " AND ".TB_PREF."task.user_id = ".db_escape($assign_to_);
	}
//	if ($contact_no!= '')
//	{
...
$sql = get_sql_for_task_inquiry( $_POST['from_date'], $_POST['to_date'], $_POST['debtor_no_'], $_POST['assign_by_']
	,$_POST['description_'],$_POST['assign_to_'],   $_POST['remarks_']);
$cols = array(
	array('insert'=>true, 'fun'=>'edit_link'),
	_("#") => array('fun'=>'view_task_link'),
	// _("X")=>array('insert'=>true, 'fun'=>'delete_checkbox'),
	_("Date")=> array( 'type'=>'date'),
        _("Time")=> array( /*'type'=>'date'*/),
	_("Description")=> array(/*'fun'=>'get_format_date'*/),
	_("Customer")=> array('fun'=>'get_customer_name1', 'align'=>'center'),
	_("Assign To") => array('fun'=>'get_users_name', 'align'=>'center'),
	_("Assign By")=> array('fun'=>'get_users_realname', 'align'=>'center'),
