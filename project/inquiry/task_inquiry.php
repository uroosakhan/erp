...
<right>
 ...
 <span class="info-box-small-text"> <a href=../inquiry/task_inquiry.php?status=5&activity=1>
<span class="info-box-small-text" style="color:white"> '; echo "$tasks_added_today"; echo ' Today</span> </a>
</span>  
           <div class="progress">
...
<span class="info-box-small-text"> <a href=../inquiry/task_inquiry.php?status=5&activity=2>
<span class="info-box-small-text" style="color:white"> '; echo "$tasks_added_yesterday"; echo ' Yesterday</span> </a>
</span>
         
          <div class="progress">
                <div class="progress-bar" style="width: 100%"></div>
              </div>
<span class="info-box-small-text"> <a href=../inquiry/task_inquiry.php?status=5&activity=3>
<span class="info-box-small-text" style="color:white"> '; echo "$tasks_added_week"; echo ' This Week</span> </a>
</span>
...
<span class="info-box-small-text"> <a href=../inquiry/task_inquiry.php?status=1&activity=1>
<span class="info-box-small-text" style="color:white"> '; echo "$tasks_completed_today"; echo ' Today</span> </a>
  ...
  <span class="info-box-small-text"> <a href=../inquiry/task_inquiry.php?status=1&activity=2>
<span class="info-box-small-text" style="color:white"> '; echo "$tasks_completed_yesterday"; echo ' Yesterday</span> </a>
</span>
     
          <div class="progress">
                <div class="progress-bar" style="width: 100%"></div>
              </div>
<span class="info-box-small-text"> <a href=../inquiry/task_inquiry.php?status=1&activity=3>
<span class="info-box-small-text" style="color:white"> '; echo "$tasks_completed_week"; echo ' This Week</span> </a>
</span>
...
<span class="info-box-small-text"> <a href=../inquiry/task_inquiry.php?status=5&activity=1>
<span class="info-box-small-text" style="color:white"> '; echo "$tasks_approved_today"; echo ' Today</span> </a>
  ...
  <span class="info-box-small-text"> <a href=../inquiry/task_inquiry.php?status=5&activity=2>
<span class="info-box-small-text" style="color:white"> '; echo "$tasks_approved_yesterday"; echo ' Yesterday</span> </a>
</span>
  ...
  <span class="info-box-small-text"> <a href=../inquiry/task_inquiry.php?status=5&activity=3>
<span class="info-box-small-text" style="color:white"> '; echo "$tasks_approved_week"; echo ' This Week</span> </a>
</span>          
...
function batch_checkbox($row)
{
	$name = "Sel_" .$row['id'];
	return
		"<input type='checkbox' name='$name' value='1' class='sendSms' >"
...
if (isset($_POST['BatchInvoice']))
{
	...
	foreach($_POST['Sel_'] as $delivery => $branch)
	{
		...
		if (check_value($checkbox))	{
			...
			update_task_category($delivery, $_POST['status_']);
		}
	}
//
//	if (!$del_count)
//	{
//		display_error(_('For sending SMS you should select at least one customer.'));
//	} else
//	{
//		$_SESSION['DeliveryBatch'] = $selected;
//		foreach ($selected as $value) {
//			$_SESSION["id"]=$value;
//			meta_forward($path_to_root . '/sms/sms_check.php','BatchInvoice=Yes&type='.ST_GATEPASS);
//		}
//	}
}

function update_task_category($reconcile_id, $reconcile_value)
{
	$sql = "UPDATE ".TB_PREF."task SET status=$reconcile_value"
...
start_row();
pstatus_list_cells(_("Status:"), 'status_', null, false);
end_row();
...
$cols = array(
	_("").
		...
		selectAll('', 'selectAll', 'selectAll', 'checkAll(this)')
...
if($_SESSION['wa_current_user']->access == 2 || $_SESSION["wa_current_user"]->access == 13)
{
	if($_SESSION['status'] == 1 || $_SESSION['status'] == 13  || $_SESSION['status'] == '')
		array_append($cols,
		array("Apl." => array('insert' => true, 'fun'=>'approved', 'align'=>'center')));
}
			array_append($cols,
		array(_("PRIORITY") => array('fun' => 'update_priority',  'ord' => '', 'align' => 'center'),
