...
if (!isset($path_to_root) || isset($_GET['path_to_root']) || isset($_POST['path_to_root']))
	...
	$debug 			= 1;	// show sql on database errors
		...
		// show all sql queries in page footer for debugging purposes1
	...
	// Powered by
	$power_by 		= "Hisaab.pk";
	$power_url 		= "http://www.hisaab.pk";
	
	//dz 1.9.17
	/**
	 * Turn select into autocomplete. In-compatible with popup search and can't be used at the same 				time.
	 */
	...
	$help_base_url = 'http://support.hisaab.pk/knowledgebase/';
	...
	$use_costed_values = 0; //ansar 26-08-17
...
*/
	$clear_trial_balance_opening = true;
