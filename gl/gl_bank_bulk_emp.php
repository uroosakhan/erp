...
$path_to_root = "..";
include_once($path_to_root . "/includes/ui/items_cart_bulk_emp.inc");
...
include_once($path_to_root . "/gl/includes/ui/gl_bank_ui_bulk_emp.inc");
...
function create_cart($type, $trans_no, $approval=0)
{
	global $Refs;
...
if (isset($_POST['Process']) && !check_trans())
{
    ...
    {
//        $abc = get_next_reference($_SESSION['pay_items']->trans_type);
        $abc = $Refs->get_next($_SESSION['pay_items']->trans_type, null, $_POST['date_']);


        //	display_error($_POST['cf_ref']);
...
//		$_POST['cheque_date'],
// $_POST['text_1'], $_POST['text_2'], $_POST['text_3'], $_POST['month_']);
...
function handle_update_item()
{
    ...
    if($_POST['UpdateItem'] != "" && check_item_data())
    {
        $_SESSION['pay_items']->update_gl_item($_POST['Index'], $_POST['code_id'],
            $_POST['dimension_id'], $_POST['dimension2_id'], $amount , $_POST['LineMemo'],null,
...
function handle_new_item()
{
    ...
    $_SESSION['pay_items']->add_gl_item($_POST['code_id'], $_POST['dimension_id'],
        $_POST['dimension2_id'], $amount, $_POST['LineMemo'],null,null,null,
        $_POST['cheque_no_line'],$_POST['cheque_date_line'],$_POST['person_id'],$_POST['PersonDetailID']);
    line_start_focus();
}
//-----------------------------------------------------------------------------------------------
...
display_bank_header_bulk_emp($_SESSION['pay_items']);

start_table(TABLESTYLE2, "width='90%'", 10);
start_row();
echo "<td>";
display_gl_items_bulk_emp($_SESSION['pay_items']->trans_type==ST_BANKPAYMENT ?
