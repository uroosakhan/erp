...
include_once($path_to_root . "/gl/includes/ui/gl_bank_ui_bulk_tax.inc");
    ...
    while($myrow = db_fetch($acc_detail))
{
    ...
    $tax_liability_account1 = get_sys_pay_pref('s_tax_liability');
...
if($amount1!=0)
        $_SESSION['pay_items']->add_gl_item($tax_liability_account, $_POST['dimension_id'],
            $_POST['dimension2_id'], $_POST['dimension3_id'], $amount1, $_POST['LineMemo'],null,
            $fiscal,$_POST['cheque_date_line'],$myrow['emp_id'],$_POST['PersonDetailID'],$_POST['month'],$_POST['mod_payment']);
        if($amount2!=0)
        $_SESSION['pay_items']->add_gl_item($tax_liability_account1, $_POST['dimension_id'],
