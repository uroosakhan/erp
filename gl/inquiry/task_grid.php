...
//
//                        },
//							template: "#= date ? kendo.format('{0:yyyy-MM-dd}', date):'null'#",
...
//							type: "date",
							...
							field: "start_date",
							title: "start_date",
//							template: '#= kendo.toString(new Date(start_date), "yyyy-MM-dd") #',
//							template: "#= kendo.toString(kendo.parseDate(start_date, 'yyyy-MM-dd'), 'yyyy-MM-dd')#",
 	width: '200px' ,format:"{0:yyyy-MM-dd}",
//							template: '#= kendo.toString(oper.toDate(start_date), "yyyy-MM-dd" ) #'
//							template: "#= kendo.toString(kendo.parseDate(start_date), 'yyyy-MM-dd')#",

//						template: "#=  (start_date == null)? '' : kendo.toString(kendo.parseDate(start_date, 'yyyy-MM-dd'), 'MM/dd/yy') #",
