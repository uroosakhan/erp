...
echo '<center><img src='.$logo.' width='.$width.' height='.$height.' ></center>';
	...
	echo '<b><center><h3>'.$coy_name.'</h3></center></b>';
...
if($_GET['unapproved']==1){


echo'
<h4><center>UnApproved Voucher</h4>
<b><center><h3>'.$row[0].'</h3></center></b>';
...
function display_gl_heading($myrow)
{
	...
	if($_GET['type_id'] == 41)
		$th = array(_("General Ledger Transaction Details"), _("Reference"),
			_("Transaction Date"), _("Journal #"),  _("Text 1")
		, _("Text 2"), _("Text 3"));
	else
		$th = array(_("General Ledger Transaction Details"), _("Reference"),
			_("Transaction Date"), _("Journal #"), _("Cheque No."), _("Cheque Date"), _("Text 1")
		, _("Text 2"), _("Text 3"));
	...
	if($_GET['type_id'] != 41) {
		if($myrow["cheque"])
			label_cell($myrow["cheque"], "align='center'");
		else
			label_cell($myrow["cheque_no"], "align='center'");

		label_cell(sql2date($myrow["cheque_date"]), "align='center'");
		//label_cell($myrow["cheq_num"], "align='center'");
	}
	label_cell($myrow["text_1"], "align='center'");
	label_cell($myrow["text_2"], "align='center'");
	label_cell($myrow["text_3"], "align='center'");
	end_row();
