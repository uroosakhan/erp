...
$result = get_bank_trans(ST_CPV, $trans_no);
...
end_row();
start_row();
label_cells(_("Pay To"), get_counterparty_name(ST_CPV, $from_trans['trans_no']), "class='tableheader2'", "colspan=$colspan1");
if ($show_currencies)
{
...
end_row();
comments_display_row(ST_CPV, $trans_no);

end_table(1);

$voided = is_voided_display(ST_CPV, $trans_no, _("This payment has been voided."));

$items = get_gl_trans(ST_CPV, $trans_no);
...
end_page(true, false, false, ST_CPV, $trans_no);
