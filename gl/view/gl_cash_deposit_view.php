...
$result = get_bank_trans(ST_CRV, $trans_no);
...
end_row();
start_row();
label_cells(_("From"), get_counterparty_name(ST_CRV, $to_trans['trans_no']), "class='tableheader2'", "colspan=$colspan1");
if ($show_currencies)
{
...
end_row();
comments_display_row(ST_CRV, $trans_no);

end_table(1);

is_voided_display(ST_CRV, $trans_no, _("This deposit has been voided."));

$items = get_gl_trans(ST_CRV, $trans_no);
...
end_page(true, false, false, ST_CRV, $trans_no);
