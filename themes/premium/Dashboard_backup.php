        ...
        echo '<div class="box box-danger">
            ...
            <div class="box-body">
              <ul class="products-list product-list-in-box">
                ...
                <li class="item" >
                 <a href="' . $path_to_root . '/purchasing/inquiry/po_search.php?" target="_blank"><i class="icon fa fa-truck"> </i> <span style="font-size: 12px;color: #000000">Outstanding GRNs</span><span class="pull-right text-red">0</span></a> 
                </li>
                <!-- /.item -->
                <li class="item" >
                 <a href="' . $path_to_root . '/purchasing/supplier_invoice.php?New=1" target="_blank"><i class="icon fa fa-user"> </i> <span style="font-size: 12px;color: #000000">Pending Supplier Bills </span><span class="pull-right text-red">0</span></a> 
                </li>
                <!-- /.item -->
