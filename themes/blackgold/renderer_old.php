...
{			$logo = "<img src='$path_to_root/themes/".user_theme(). "/images/logo.png' width='180' height='60' border='0' alt='"._('Logo')."'>&nbsp;&nbsp;";
       		echo $logo;
			echo "  </div>\n"; 
			...
			echo "  <div id='iconlink'>";
	   		...
	   		if (!$no_menu) {
        		echo "    <a class='shortcut' href='$local_path_to_root/access/logout.php?'><img src='$local_path_to_root/themes/arkadians/images/system-shutdown.png' title='"._("Logout")."' /></a>";
     		}
  			// Popup help
     		if ($help_base_url != null) {
			  echo "<a target = '_blank' onclick=" .'"'."javascript:openWindow(this.href,this.target); return false;".'" '. "href='". help_url()."'><img src='$local_path_to_root/themes/arkadians/images/help-browser.png' title='"._("Help")."' /></a>\n";
	   		}
     		echo "  </div>\n"; // iconlink
     		echo "  </div>\n";
...
//                        $leftmenu_save .= "    <div class='menutitle'>Modules</div>\n";
                        $leftmenu_save .= "    <ul>\n";
                    ...
                    //   foreach($applications as $app)
						...
						/*	if ($app->id == 'dashboard')
					        {
								$leftmenu_save .= "  <div id='icon1'></div>\n";
							}
*/
	//						if ($app->id == 'orders')
					        {
		                    /*    $leftmenu_save .= "  <div id='ddblueblockmenu'>\n";
								$leftmenu_save .= "  <div id='dashboardicon'>\n";
								$leftmenu_save .= "      <li>\n";
								$leftmenu_save .= "        <a  class='"
									.($sel_app == $app->id ? 'selected' : 'menu_tab')
									."'href='$local_path_to_root/index.php?application=dashboard".
								SID ."'$acc[1]>" .'Dashboard' . "</a>\n"; 
								$leftmenu_save .= "      </li>\n";
								*/

								$leftmenu_save .= "  <div id='ordersicon'>\n";						
								$leftmenu_save .= "      <li>\n";
								$leftmenu_save .= "        <a  class='"
									.($sel_app == $app->id ? 'selected' : 'menu_tab')
									."'href='$local_path_to_root/index.php?application=orders".
								SID ."'$acc[1]>" .'Bookings' . "</a>\n"; 
								$leftmenu_save .= "      </li>\n";



							/*	$leftmenu_save .= "  <div id='apicon'>\n";								
								$leftmenu_save .= "      <li>\n";
								$leftmenu_save .= "        <a  class='"
									.($sel_app == $app->id ? 'selected' : 'menu_tab')
									."'href='$local_path_to_root/index.php?application=AP".
								SID ."'$acc[1]>" .'Suppliers' . "</a>\n"; 
								$leftmenu_save .= "      </li>\n";
							*/

								$leftmenu_save .= "  <div id='stockicon'>\n";								
								$leftmenu_save .= "      <li>\n";
								$leftmenu_save .= "        <a  class='"
									.($sel_app == $app->id ? 'selected' : 'menu_tab')
									."'href='$local_path_to_root/index.php?application=units".
								SID ."'$acc[1]>" .'Units' . "</a>\n"; 
								$leftmenu_save .= "      </li>\n";

							/*	$leftmenu_save .= "  <div id='projicon'>\n";								
								$leftmenu_save .= "      <li>\n";
								$leftmenu_save .= "        <a  class='"
									.($sel_app == $app->id ? 'selected' : 'menu_tab')
									."'href='$local_path_to_root/index.php?application=proj".
								SID ."'$acc[1]>" .'Cost Centres' . "</a>\n"; 
								$leftmenu_save .= "      </li>\n";
							*/

								$leftmenu_save .= "  <div id='glicon'>\n";								
								$leftmenu_save .= "      <li>\n";
								$leftmenu_save .= "        <a  class='"
									.($sel_app == $app->id ? 'selected' : 'menu_tab')
									."'href='$local_path_to_root/index.php?application=reporting".
								SID ."'$acc[1]>" .'Reporting' . "</a>\n"; 
								$leftmenu_save .= "      </li>\n";


								$leftmenu_save .= "  <div id='systemicon'>\n";								
								$leftmenu_save .= "      <li>\n";
								$leftmenu_save .= "        <a  class='"
									.($sel_app == $app->id ? 'selected' : 'menu_tab')
									."'href='$local_path_to_root/index.php?application=system".
								SID ."'$acc[1]>" .'Settings' . "</a>\n"; 
								$leftmenu_save .= "      </li>\n";
