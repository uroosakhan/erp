...
include_once($path_to_root . "/POS/includes/ui/sales_order_ui2.inc");
...
function handle_new_item($stk_id)
{
    ...
    add_to_order($_SESSION['Items'], $stk_id, $qty,
        $price, $price_discount/100, get_post('stock_id_text'), $deal_price, $stk_id);
...
function handle_new_item_old()
{
    ...
    add_to_order($_SESSION['Items'], get_post('stock_id'), input_num('qty'),
        $price, input_num('Disc') / 100, get_post('stock_id_text'),$deal_price,get_post('stock_id'));
    /*add_to_order($_SESSION['Items'], $stk_id, $qty,
