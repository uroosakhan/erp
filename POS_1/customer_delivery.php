...
$_POST['DispatchDate']= get_current_company_date(3);
}
else{
   $_POST['DispatchDate']; 
...
if (!isset($_POST['due_date']) || !is_date($_POST['due_date'])) {
	$_POST['due_date'] = get_invoice_duedate_pos($_SESSION['Items']->payment, $_POST['DispatchDate']);
}
...
label_row(_("Discount"), $_SESSION['Items']->total_discount.' %', "colspan=$colspan align=right","align=right");
