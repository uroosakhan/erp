...
page(_($help_context = "Delivery Orders "));
...
function get_cus_for_delivery_table()
{
	$sql ="SELECT * FROM `".TB_PREF."debtors_master` where table_type=2  GROUP BY debtor_no ASC";
...
echo'<div style="font-size: 26px;">Delivery Tables</div>';
echo'<div style="height:;width:90%;" >';

$data = get_cus_for_delivery_table();
