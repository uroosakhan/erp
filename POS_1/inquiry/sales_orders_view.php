...
function inc_cust($row)
{
	return
		///sales/customer_delivery.php?OrderNumber=
		pager_link_js_confirm( _("Delivery"),
			"/POS/cust_delivery.php?OrderNumber=" .$row['order_no'], ICON_DOC,
			_("You are about to generate DN and Invoice.\n Do you want to continue?"));

	//	delete_button_cell("restore", _("Delete"));
...
function edit_link($row) 
{
  ...
  return pager_link( _("Edit"),
    "/POS/sales_order_entry.php?$modify=" . $row['order_no']."&&change=YES", ICON_EDIT);
}
...
function dispatch_link($row)
{
	...
	if ($trans_type == ST_SALESORDER)
  		return pager_link( _("Dispatch"),
			"/POS/customer_delivery.php?OrderNumber=" .$row['order_no'], ICON_DOC);
	else		
  		return pager_link( _("Sales Order"),
			"/POS/sales_order_entry.php?OrderNumber=" .$row['order_no'], ICON_DOC);
}
...
function invoice_link($row)
{
	...
	if ($trans_type == ST_SALESORDER)
  		return pager_link( _("Invoice"),
			"/POS/sales_order_entry.php?NewInvoice=" .$row["order_no"], ICON_DOC);
	else
		return '';
}
...
function delivery_link($row)
{
  return pager_link( _("Delivery"),
	"/POS/sales_order_entry.php?NewDelivery=" .$row['order_no'], ICON_DOC);
}

function order_link($row)
{
  return pager_link( _("Sales Order"),
	"/POS/sales_order_entry.php?NewQuoteToSalesOrder=" .$row['order_no'], ICON_DOC);
}
...
//
$sql = get_sql_for_sales_orders_view_pos($selected_customer, $trans_type, $_POST['OrderNumber'], $_POST['order_view_mode'],
	...
	array_append($cols, array(
	 ...
	 array_append($cols,array(
			_("Tmpl") => array('insert'=>true, 'fun'=>'tmpl_checkbox'),
					array('insert'=>true, 'fun'=>'edit_link'),
					array('insert'=>true, 'fun'=>'inc_cust'),
					array('insert'=>true, 'fun'=>'prt_link')));
};
