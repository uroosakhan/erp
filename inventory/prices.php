...
if ($Mode=='ADD_ITEM' || $Mode=='UPDATE_ITEM') 
{
	...
	if(input_num('discount') < 0 || input_num('discount') > 100  ){
	...
	if ($input_error != 1)
	{
    	...
    	if ($selected_id != -1) 
		{
			...
			$_POST['curr_abrev'], input_num('price'), input_num('discount'));
...
$th = array(_("Currency"), _("Sales Type"), _("Price"),_("Discount %"), "", "");
table_header($th);
...
small_amount_row(_("Discount:"), 'discount', null,'', _('%') );
