...
color_list_cells(_("Theme Color"), 'color', null,$name_yes="", $name_no="",$name_blue_lite="",$name_blue="",$name_black="",$name_purple="",
    $name_green="",$name_red="",$name_yellow="",$blacklight="",$yellowlight="",$greenlight="",
    $submit_on_change=true,true);


//display_error($name_yes);
