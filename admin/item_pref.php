              ...
              //  display_error($pos1<2);
                if($pos1<2)
                {
                    $sql = "UPDATE `0_item_pref` SET
                                ...
                                inventory_enable =".db_escape(get_post('inventory_enable1'))." ,
                                ...
                                i_position =".db_escape(get_post('i_position1'))." ,
                ...
                if($pos2<2)
                {
                    $sql1 = "UPDATE `0_item_pref` SET
                                ...
                                inventory_enable =".db_escape(get_post('inventory_enable2'))." ,
                                ...
                                i_position =".db_escape(get_post('i_position2'))." ,
                ...
                if($pos3 < 2) {
                    ...
                    $sql2 = "UPDATE `0_item_pref` SET
                                ...
                                inventory_enable =" . db_escape(get_post('inventory_enable3')) . ",
                                ...
                                i_position =" . db_escape(get_post('i_position3')) . ",
                ...
                if($pos4<2) {
                    $sql3 = "UPDATE `0_item_pref` SET
                                ...
                                inventory_enable =" . db_escape(get_post('inventory_enable4')) . ",
                                ...
                                i_position =" . db_escape(get_post('i_position4')) . ",
                ...
                if($pos5<2) {
                    $sql4 = "UPDATE `0_item_pref` SET
                                ...
                                inventory_enable =" . db_escape(get_post('inventory_enable5')) . ",
                                ...
                                i_position =" . db_escape(get_post('i_position5')) . ",
                ...
                if($pos6<2) {
                    $sql5 = "UPDATE `0_item_pref` SET
                                ...
                                inventory_enable =" . db_escape(get_post('inventory_enable6')) . ",
                                ...
                                i_position =" . db_escape(get_post('i_position6')) . ",
                ...
                if($pos7<2) {
                    $sql6 = "UPDATE `0_item_pref` SET
                                ...
                                inventory_enable =" . db_escape(get_post('inventory_enable7')) . ",
                ...
                $sql7 = "UPDATE `0_item_pref` SET
                                ...
                                inventory_enable =".db_escape(get_post('inventory_enable8')).",
                ...
                $sql8 = "UPDATE `0_item_pref` SET
                                ...
                                inventory_enable =".db_escape(get_post('inventory_enable9')).",
                ...
                $sql9 = "UPDATE `0_item_pref` SET
                                ...
                                inventory_enable =".db_escape(get_post('inventory_enable10')).",
                ...
                $sql10 = "UPDATE `0_item_pref` SET
                                ...
                                inventory_enable =".db_escape(get_post('inventory_enable110')).",
                ...
                $sql11 = "UPDATE `0_item_pref` SET
                                ...
                                inventory_enable =".db_escape(get_post('inventory_enable12')).",
                                ...
                                i_position =".db_escape(get_post('i_position12')).",
                                p_position =".db_escape(get_post('p_position12')).",
                                s_width =".db_escape(get_post('s_width12')).",
                                p_width =".db_escape(get_post('p_width12')).",
                  item_combo_search =".db_escape(get_post('conacate_enable5'))."      
                               
                                WHERE  name='text6'";
                db_query($sql11,"The sales group could not be updated");

        $sql22 = "UPDATE `0_item_pref` SET
                                label_value =".db_escape(get_post('label_value16')).",
                                item_enable =".db_escape(get_post('item_enable16')).",
                                inventory_enable =".db_escape(get_post('inventory_enable16')).",
                                sale_enable =".db_escape(get_post('sale_enable16')).",
                                purchase_enable =".db_escape(get_post('purchase_enable16')).",
                                s_position =".db_escape(get_post('s_position16')).",
                                i_position =".db_escape(get_post('i_position16')).",
                                p_position =".db_escape(get_post('p_position16')).",
                                s_width =".db_escape(get_post('s_width16')).",
                                p_width =".db_escape(get_post('p_width16'))."
                                WHERE  name='text7'";
        db_query($sql22,"The sales group could not be updated");

                $sql12 = "UPDATE `0_item_pref` SET
                                label_value =".db_escape(get_post('label_value34')).",
                                item_enable =".db_escape(get_post('item_enable34')).",
                                inventory_enable =".db_escape(get_post('inventory_enable34')).",
                                ...
                                i_position =".db_escape(get_post('i_position34')).",
                ...
                $sql13 = "UPDATE `0_item_pref` SET
                                ...
                                inventory_enable = ".db_escape(get_post('inventory_enable13')).",
                ...
                $sql14 = "UPDATE `0_item_pref` SET
                                ...
                                inventory_enable =".db_escape(get_post('inventory_enable14')).",
...
//        display_error("asdasdsad");
                $sql15 = "UPDATE `0_item_pref` SET
                                ...
                                inventory_enable =".db_escape(get_post('inventory_enable15')).",
             ...
             $sql15 = "UPDATE `0_item_pref` SET
                        ...
                        p_position =".db_escape(get_post('p_position34')).",
                                ...
                                item_combo_search =".db_escape(get_post('conacate_enable9'))."
                ...
                $sql16 = "UPDATE `0_item_pref` SET
                                ...
                                inventory_enable =".db_escape(get_post('inventory_enable35')).",
                ...
                $sql17 = "UPDATE `0_item_pref` SET
                                ...
                                inventory_enable =".db_escape(get_post('inventory_enable36')).",
                ...
                $sql18 = "UPDATE `0_item_pref` SET
                                ...
                                inventory_enable =".db_escape(get_post('inventory_enable102')).",
                                ...
                                i_position =".db_escape(get_post('i_position102')).",
                ...
                $sql19 = "UPDATE `0_item_pref` SET
                                ...
                                inventory_enable =".db_escape(get_post('inventory_enable101')).",
                                ...
                                i_position =".db_escape(get_post('i_position101')).",
                ...
                $sql20 = "UPDATE `0_item_pref` SET
                                ...
                                inventory_enable =".db_escape(get_post('inventory_enable100')).",
                                ...
                                i_position =".db_escape(get_post('i_position100')).",
                ...
                $sql21 = "UPDATE `0_item_pref` SET
                                ...
                                inventory_enable =".db_escape(get_post('inventory_enable666')).",
        ...
        $sql212 = "UPDATE `0_item_pref` SET
						...
						inventory_enable =".db_escape(get_post('inventory_enable300')).",
        ...
        $sql213 = "UPDATE `0_item_pref` SET
                  label_value =".db_escape(get_post('label_value_factors')).",
						item_enable =".db_escape(get_post('item_enable301')).",
						inventory_enable =".db_escape(get_post('inventory_enable301')).",
        ...
        $sql2133 = "UPDATE `0_item_pref` SET
						...
						inventory_enable =".db_escape(get_post('inventory_enable3011')).",
        ...
        $sql2133 = "UPDATE `0_item_pref` SET
						item_enable =".db_escape(get_post('item_enable30112')).",
						sale_enable =".db_escape(get_post('sale_enable30112')).",
						purchase_enable =".db_escape(get_post('purchase_enable30112'))."
						WHERE  name='item_code_auto'";
        db_query($sql2133,"The sales group could not be updated");



        $sql21333 = "UPDATE `0_item_pref` SET
						item_enable =".db_escape(get_post('item_enable301122')).",
						sale_enable =".db_escape(get_post('sale_enable301122')).",
						purchase_enable =".db_escape(get_post('purchase_enable301122'))."
						WHERE  name='itemwise_discount'";
        db_query($sql21333,"The sales group could not be updated");



        $sql21_uom = "UPDATE `0_item_pref` SET
						item_enable =".db_escape(get_post('alt_uom123'))."
					
						WHERE  name='alt_uom'";
        db_query($sql21_uom,"The sales group could not be updated");
...
$_POST['inventory_enable110'] = $myrow11["inventory_enable"];
...
$_POST['i_position12'] = $myrow12["i_position"];
$_POST['p_position12'] = $myrow12["p_position"];
$_POST['s_width12'] = $myrow12["s_width"];
$_POST['p_width12'] = $myrow12["p_width"];
$_POST['conacate_enable5'] = $myrow12["item_combo_search"];


$myrow22 = get_company_item_pref('text7');
$_POST['label_value16'] = $myrow22["label_value"];
$_POST['item_enable16'] = $myrow22["item_enable"];
$_POST['inventory_enable16'] = $myrow22["inventory_enable"];
$_POST['sale_enable16'] = $myrow22["sale_enable"];
$_POST['purchase_enable16'] = $myrow22["purchase_enable"];
$_POST['s_position16'] = $myrow22["s_position"];
$_POST['i_position16'] = $myrow22["i_position"];
$_POST['p_position16'] = $myrow22["p_position"];
$_POST['s_width16'] = $myrow22["s_width"];
$_POST['p_width16'] = $myrow22["p_width"];

$myrow33 = get_company_item_pref('combo1');
$_POST['label_value13'] = $myrow33["label_value"];
$_POST['item_enable13'] = $myrow33["item_enable"];
$_POST['inventory_enable13'] = $myrow33["inventory_enable"];
...
$_POST['i_position13'] = $myrow33["i_position"];
$_POST['p_position13'] = $myrow33["p_position"];

$_POST['conacate_enable6'] = $myrow33["item_combo_search"];
...
$_POST['inventory_enable14'] = $myrow44["inventory_enable"];
...
$_POST['i_position14'] = $myrow44["i_position"];
$_POST['p_position14'] = $myrow44["p_position"];
$_POST['conacate_enable7'] = $myrow44["item_combo_search"];
...
$_POST['inventory_enable15'] = $myrow55["inventory_enable"];
...
$_POST['i_position15'] = $myrow55["i_position"];
$_POST['p_position15'] = $myrow55["p_position"];
$_POST['conacate_enable8'] = $myrow55["item_combo_search"];
...
$_POST['inventory_enable34'] = $myrow13["inventory_enable"];
...
$_POST['i_position34'] = $myrow13["i_position"];
$_POST['p_position34'] = $myrow13["p_position"];
$_POST['conacate_enable9'] = $myrow13["item_combo_search"];
...
$_POST['inventory_enable35'] = $myrow35["inventory_enable"];
...
$_POST['i_position35'] = $myrow35["i_position"];
$_POST['p_position35'] = $myrow35["p_position"];
$_POST['conacate_enable10'] = $myrow35["item_combo_search"];
...
$_POST['inventory_enable36'] = $myrow36["inventory_enable"];
...
$_POST['i_position36'] = $myrow36["i_position"];
$_POST['p_position36'] = $myrow36["p_position"];

$_POST['conacate_enable11'] = $myrow36["item_combo_search"];
...
$_POST['inventory_enable100'] = $myrow14["inventory_enable"];
...
$_POST['i_position100'] = $myrow14["i_position"];
...
$_POST['inventory_enable101'] = $myrow15["inventory_enable"];
...
$_POST['i_position101'] = $myrow15["i_position"];
...
$_POST['inventory_enable102'] = $myrow16["inventory_enable"];
...
$_POST['i_position102'] = $myrow16["i_position"];
...
$_POST['inventory_enable300'] = $myrow300["inventory_enable"];
...
$_POST['inventory_enable301'] = $myrow301["inventory_enable"];
...
$_POST['inventory_enable3011'] = $myrow3011["inventory_enable"];
$_POST['sale_enable3011'] = $myrow3011["sale_enable"];
$_POST['purchase_enable3011'] = $myrow3011["purchase_enable"];

$myrow30112 = get_company_item_pref('item_code_auto');
$_POST['item_enable30112'] = $myrow30112["item_enable"];
$_POST['sale_enable30112'] = $myrow30112["sale_enable"];
$_POST['purchase_enable30112'] = $myrow30112["purchase_enable"];

$myrow301122 = get_company_item_pref('itemwise_discount');
$_POST['item_enable301122'] = $myrow301122["item_enable"];
$_POST['sale_enable301122'] = $myrow301122["sale_enable"];
$_POST['purchase_enable301122'] = $myrow301122["purchase_enable"];



$myrow3011223 = get_company_item_pref('alt_uom');
$_POST['alt_uom123'] = $myrow3011223["item_enable"];
...
"<tr><td colspan='' class='tableheader'> &nbsp;  &nbsp; </td>
		...
		<td colspan='' class='tableheader'>&nbsp; Inventory Enable &nbsp;</td>
		<td colspan='' class='tableheader'>&nbsp; Sale Enable &nbsp;</td>
			<td colspan='' class='tableheader'>&nbsp; Purchase Enable &nbsp;</td>	<td colspan='' class='tableheader'>&nbsp;</td>
...
"<tr><td colspan='' class='tableheader'> &nbsp; Label &nbsp; </td>
	...
	check_cells(_("Alt. Unit Of Measure"), 'alt_uom123', $_POST['alt_uom123']);

	echo"<tr>";

check_cells(_("Item Code Enable"), 'item_enable30112', $_POST['item_enable30112']);
	check_cells(_(""), 'sale_enable30112', $_POST['sale_enable30112']);
	check_cells(_(""), 'purchase_enable30112', $_POST['purchase_enable30112']);
	echo"<tr>";
	check_cells(_("Itemwise Discount"), 'item_enable301122', $_POST['item_enable301122']);
	check_cells(_(""), 'sale_enable301122', $_POST['sale_enable301122']);
	check_cells(_(""), 'purchase_enable301122', $_POST['purchase_enable301122']);
...
check_cells(_(""), 'inventory_enable3011', $_POST['inventory_enable3011']);
check_cells(_(""), 'sale_enable3011', $_POST['sale_enable3011']);
check_cells(_(""), 'purchase_enable3011', $_POST['purchase_enable3011']);
echo"<tr>";
echo"<tr>";
text_cells_readonly(null, 'label_value_factors','Conversion Factor',12,30,
    false,$_POST['label_value_factors']);
    
    
    
//label_cells(_("Conversion Factor"),$_POST['label_value_factors']);
check_cells(_(""), 'item_enable301', $_POST['item_enable301']);
check_cells(_(""), 'inventory_enable301', $_POST['inventory_enable301']);
...
check_cells(_(""), 'inventory_enable1', $_POST['inventory_enable1']);
...
text_cells6(_(""), 'i_position1', $_POST['i_position1'], 10);
...
check_cells(_(""),'inventory_enable2', null);
...
text_cells6(_(""), 'i_position2', $_POST['i_position2'], 10);
...
check_cells(_(""),'inventory_enable3', null);
...
text_cells6(_(""), 'i_position3', $_POST['i_position3'], 10);
...
check_cells(_(""),'inventory_enable4', null);
...
text_cells6(_(""), 'i_position4', $_POST['i_position4'], 10);
...
check_cells(_(""),'inventory_enable5', null);
...
text_cells6(_(""), 'i_position5', $_POST['i_position5'], 10);
...
check_cells(_(""),'inventory_enable6', null);
...
text_cells6(_(""), 'i_position6', $_POST['i_position6'], 10);
...
"<tr><td colspan='' class='tableheader'> &nbsp;  &nbsp; </td>
		...
		<td colspan='' class='tableheader'>&nbsp; Sale Enable &nbsp;</td>
			...
			<td colspan='' class='tableheader'>&nbsp; Search in item dropdown	  &nbsp;</td>
			<td colspan='' class='tableheader'>&nbsp;   &nbsp;</td>
		</tr>
		";
...
check_cells(_(""),'inventory_enable7', null);
check_cells(_(""),'sale_enable7', null);
check_cells(_(""),'purchase_enable7', null);
check_cells(_(""),'conacate_enable0', null);

echo"<tr>";
echo"<td>";
text_cells(_(""), 'label_value7', $_POST['label_value7'], 20);
text_cells6(_(""), 'i_position7', $_POST['i_position7'], 10);
...
check_cells(_(""),'inventory_enable8', null);
check_cells(_(""),'sale_enable8', null);
check_cells(_(""),'purchase_enable8', null);
check_cells(_(""),'conacate_enable1', null);

echo"<tr>";
echo"<td>";
text_cells(_(""), 'label_value8', $_POST['label_value8'], 20);
text_cells6(_(""), 'i_position8', $_POST['i_position8'], 10);
...
check_cells(_(""),'inventory_enable9', null);
check_cells(_(""),'sale_enable9', null);
check_cells(_(""),'purchase_enable9', null);
check_cells(_(""),'conacate_enable2', null);

echo"<tr>";
echo"<td>";
text_cells(_(""), 'label_value9', $_POST['label_value9'], 20);
text_cells6(_(""), 'i_position9', $_POST['i_position9'], 10);
...
check_cells(_(""),'inventory_enable10', null);
check_cells(_(""),'sale_enable10', null);
check_cells(_(""),'purchase_enable10', null);
check_cells(_(""),'conacate_enable3', null);

echo"<tr>";
echo"<td>";
text_cells(_(""), 'label_value10', $_POST['label_value10'], 20);
text_cells6(_(""), 'i_position10', $_POST['i_position10'], 10);
...
check_cells(_(""),'inventory_enable110', null);
check_cells(_(""),'sale_enable110', null);
check_cells(_(""),'purchase_enable110', null);
check_cells(_(""),'conacate_enable4', null);

echo"<tr>";
echo"<td>";
text_cells(_(""), 'label_value110', $_POST['label_value110'], 20);
text_cells6(_(""), 'i_position110', $_POST['i_position110'], 10);
...
check_cells(_(""),'inventory_enable12', null);
check_cells(_(""),'sale_enable12', null);
check_cells(_(""),'purchase_enable12', null);
check_cells(_(""),'conacate_enable5', null);

echo"<tr>";
echo"<td>";
text_cells(_(""), 'label_value12', $_POST['label_value12'], 20);
text_cells6(_(""), 'i_position12', $_POST['i_position12'], 10);
...
check_cells(_("Long Text Field"), 'item_enable16', null);
check_cells(_(""),'inventory_enable16', null);
check_cells(_(""),'sale_enable16', null);
check_cells(_(""),'purchase_enable16', null);

echo"<tr>";
echo"<td>";
text_cells(_(""), 'label_value16', $_POST['label_value16'], 20);
text_cells6(_(""), 'i_position16', $_POST['i_position16'], 10);
text_cells5(_(""), 's_position16', $_POST['s_position16'], 10);
text_cells4(_(""), 'p_position16', $_POST['p_position16'], 10);
text_cells2(_(""), 's_width16', $_POST['s_width16'], 10);
text_cells3(_(""), 'p_width16', $_POST['p_width16'], 10);
echo"</tr>";
echo"<tr>";
...
check_cells(_(""),'inventory_enable100', null);
...
text_cells6(_(""), 'i_position100', $_POST['i_position100'], 10);
...
check_cells(_(""),'inventory_enable101', null);
...
text_cells6(_(""), 'i_position101', $_POST['i_position101'], 10);
...
check_cells(_(""),'inventory_enable102', null);
...
text_cells6(_(""), 'i_position102', $_POST['i_position102'], 10);
...
check_cells(_(""), 'inventory_enable300', $_POST['inventory_enable300']);
...
check_cells(_(""),'inventory_enable13', null);
check_cells(_(""),'sale_enable13', null);
check_cells(_(""),'purchase_enable13', null);
check_cells(_(""),'conacate_enable6', null);
...
text_cells6(_(""), 'i_position13', $_POST['i_position13'], 10);
...
check_cells(_(""),'inventory_enable14', null);
check_cells(_(""),'sale_enable14', null);
check_cells(_(""),'purchase_enable14', null);
check_cells(_(""),'conacate_enable7', null);

echo"<tr>";
echo"<td>";
text_cells(_(""), 'label_value14', $_POST['label_value14'], 20);
text_cells6(_(""), 'i_position14', $_POST['i_position14'], 10);
...
check_cells(_(""),'inventory_enable15', null);
check_cells(_(""),'sale_enable15', null);
check_cells(_(""),'purchase_enable15', null);
check_cells(_(""),'conacate_enable8', null);

echo"<tr>";
echo"<td>";
text_cells(_(""), 'label_value15', $_POST['label_value15'], 20);
text_cells6(_(""), 'i_position15', $_POST['i_position15'], 10);
...
check_cells(_(""),'inventory_enable34', null);
check_cells(_(""),'sale_enable34', null);
check_cells(_(""),'purchase_enable34', null);
check_cells(_(""),'conacate_enable9', null);

echo"<tr>";
echo"<td>";
text_cells(_(""), 'label_value34', $_POST['label_value34'], 20);
text_cells6(_(""), 'i_position34', $_POST['i_position34'], 10);
...
check_cells(_(""),'inventory_enable35', null);
check_cells(_(""),'sale_enable35', null);
check_cells(_(""),'purchase_enable35', null);
check_cells(_(""),'conacate_enable10', null);

echo"<tr>";
echo"<td>";
text_cells(_(""), 'label_value35', $_POST['label_value35'], 20);
text_cells6(_(""), 'i_position35', $_POST['i_position35'], 10);
...
check_cells(_(""),'inventory_enable36', null);
check_cells(_(""),'sale_enable36', null);
check_cells(_(""),'purchase_enable36', null);
check_cells(_(""),'conacate_enable11', null);

echo"<tr>";
echo"<td>";
text_cells(_(""), 'label_value36', $_POST['label_value36'], 20);
text_cells6(_(""), 'i_position36', $_POST['i_position36'], 10);
