...
function print_customer_balances()
{
	...
	$cols = array(0, 70, 140, 190,	250, 300, 340, 400,	450,515);

	$headers = array(_('Customer Name'),_('#'), _('Date'), _('Trans Type'), _('Due Date'), _('Charges'), _('Credits'),
...
//    }
	...
	while ($myrow = db_fetch($result))
	{
		...
		while ($trans = db_fetch($res))
		{
			...
			$rep->TextCol(3, 4, $systypes_array[$trans['type']]);
