...
$cols = array(2, 50, 110, 135, 280, 352, 435, 520);

    $headers = array(_('Date'), _('Ref'), _('Num'), _('Memo'), _('Debit'), _('Credits'),
        _('Balance'));
...
//			if ($show_balance)
    ...
    //         	if ($rep->row < $rep->bottomMargin + $rep->lineHeight)
				// {
		$rep->LineTo($rep->leftMargin, 55.4* $rep->lineHeight ,$rep->leftMargin, $rep->row-2);
        $rep->LineTo($rep->pageWidth - $rep->rightMargin,55.4 * $rep->lineHeight,$rep->pageWidth - $rep->rightMargin, $rep->row-2);
        $rep->LineTo($rep->pageWidth - $rep->rightMargin - 87, 55.4* $rep->lineHeight, $rep->pageWidth - $rep->rightMargin - 87, $rep->row-2);
        $rep->LineTo($rep->pageWidth - $rep->rightMargin - 169, 55.4 * $rep->lineHeight, $rep->pageWidth - $rep->rightMargin - 169, $rep->row-2);
        $rep->LineTo($rep->pageWidth - $rep->rightMargin - 250, 55.4 * $rep->lineHeight, $rep->pageWidth - $rep->rightMargin - 250, $rep->row-2);
        $rep->LineTo($rep->pageWidth - $rep->rightMargin - 393, 55.4 * $rep->lineHeight, $rep->pageWidth - $rep->rightMargin - 393, $rep->row-2);
        $rep->LineTo($rep->pageWidth - $rep->rightMargin - 417, 55.4 * $rep->lineHeight, $rep->pageWidth - $rep->rightMargin - 417, $rep->row-2);	
					$rep->Line($rep->row-2);	
				
				// 	$rep->NewPage();
				// }
        }
        $rep->LineTo($rep->leftMargin, 55.4 * $rep->lineHeight ,$rep->leftMargin, $rep->row-52);
        $rep->LineTo($rep->pageWidth - $rep->rightMargin,55.4 * $rep->lineHeight,$rep->pageWidth - $rep->rightMargin, $rep->row-52);
        $rep->LineTo($rep->pageWidth - $rep->rightMargin - 87, 55.4* $rep->lineHeight, $rep->pageWidth - $rep->rightMargin - 87, $rep->row-52);
        $rep->LineTo($rep->pageWidth - $rep->rightMargin - 169, 55.4 * $rep->lineHeight, $rep->pageWidth - $rep->rightMargin - 169, $rep->row-52);
        $rep->LineTo($rep->pageWidth - $rep->rightMargin - 250, 55.4 * $rep->lineHeight, $rep->pageWidth - $rep->rightMargin - 250, $rep->row-52);
        $rep->LineTo($rep->pageWidth - $rep->rightMargin - 393, 55.4 * $rep->lineHeight, $rep->pageWidth - $rep->rightMargin - 393, $rep->row-52);
        $rep->LineTo($rep->pageWidth - $rep->rightMargin - 417, 55.4 * $rep->lineHeight, $rep->pageWidth - $rep->rightMargin - 417, $rep->row-52);
...
//    	$grandtotal[1] += $total[1];
    ...
    $rep->AmountCol(6, 7, $grandtotal[3], $dec);
    $rep->Font('');
    $rep->Line($rep->row  - 4);
    $rep->NewLine();
    $rep->End();
