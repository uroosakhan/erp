...
function print_po()
{
	...
	$cols = array(4, 50,120,155, 210, 270, 320,358,390, 450, 455, 470);
...
//            display_error($item['units']."+".$myrow2['units_id']);
...
$rep->TextCol(9, 10,	sql2date($myrow2['delivery_date']), -2);
