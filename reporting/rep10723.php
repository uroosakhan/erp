...
//				$rep->AmountCol(2, 3,	$unit_price, $dec);
				$rep->AmountCol(2, 3, $myrow2["quantity"], $dec);
...
//				$rep->multicell(65, 5, price_format($TOTAL), 0, 'R', 0, 0, 455, 575);
				$amount_in_words = _number_to_words($TOTAL);
				$rep->multicell(400, 15, " " . $amount_in_words, 0, 'L', 0, 0, 125, 530);
				$rep->font('b');
				$rep->multicell(85,15,"  Amount in words:",0,'L',0,0,40,530);
				$rep->font('');
			}
			$rep->row = $newrow;
			$rep->NewLine(1);
...
//		$words = price_in_words($myrow['Total'], ST_SALESINVOICE);
	$rep->MultiCell(250, 20, $sales_order['name'], 0, 'L', 0, 2, 70,170, true);
