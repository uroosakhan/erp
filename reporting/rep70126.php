...
function print_Chart_of_Accounts()
{
	...
	$cols = array(2, 50, 180, 323, 435, 480);
...
//    $rep->MultiCell(250, 20, "DATE:  ".$date ,0, 'L', 0, 2, 450,50, true);
	...
	$rep->MultiCell(160, 20, "Date:  ".sql2date($from_trans['tran_date']) ,0, 'L', 0, 2, 50,110, true);

	$rep->MultiCell(160, 20, "Number :  ". $from_trans["type_no"] ,0, 'L', 0, 2, 50,100, true);

	$rep->MultiCell(160, 20, "Journal Ref:  ". /*$from_trans["ref"] */get_reference(ST_JOURNAL,$trans_no),0, 'R', 0, 2, 400,110, true);
...
//        alt_table_row_color($k);
    ...
    $rep->MultiCell(100, 25, "" . number_format2($dr_amount), 0, 'C', 0, 2, 450, 312, true);

    $rep->MultiCell(100, 25, "".(number_format2($dr_amount)), 0, 'C', 0, 2, 490, 312, true);

//    $amounts = ($myrow1['amount'] * -1);
    $rep->MultiCell(350, 20, 'Rupees:' . convert_number_to_words($dr_amount) . ' Only', 1, 'L', 0, 2, 60, 345, true);
    $rep->MultiCell(120, 20, number_format2($dr_amount), 1, 'C', 0, 2, 420, 345, true);


    $user =get_user_login();
	$rep->MultiCell(100, 25, "______________________" ,0, 'L', 0, 2, 40,387, true);
	$rep->MultiCell(100, 25, "______________________" ,0, 'L', 0, 2, 160,387, true);
	$rep->MultiCell(100, 25, "______________________" ,0, 'L', 0, 2, 280,387, true);
	$rep->MultiCell(100, 25, "______________________" ,0, 'L', 0, 2, 400,387, true);
// 	$rep->MultiCell(100, 25, "".get_user_name_70123($user['user']) ,0, 'C', 0, 2, 37,698, true);

$user =get_user_id($trans_no,ST_JOURNAL);
		$rep->MultiCell(100, 25, "".get_user_name_70123($user) ,0, 'l', 0, 2, 68,380, true);
	$rep->MultiCell(100, 25, "Prepared By" ,0, 'C', 0, 2, 40,398, true);
	$rep->MultiCell(100, 25, "Checked By" ,0, 'C', 0, 2, 160,398, true);
	$rep->MultiCell(100, 25, "Approved By" ,0, 'C', 0, 2, 280,398, true);
	$rep->MultiCell(100, 25, "Recieved By" ,0, 'C', 0, 2, 400,398, true);
	$rep->MultiCell(100, 25, "Total" ,0, 'C', 0, 2, 350,312, true);
	$rep->MultiCell(525, 17, "" ,1, 'C', 0, 2, 40,309, true);
