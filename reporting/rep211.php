...
//			$rep->NewLine(1);
        ...
        $rep->MultiCell(230,13," PO No:          ".get_ref_for_order_no($myrow["trans_no"]),0,'L', 0, 2,402,115,true);
        $rep->MultiCell(230,13," GRN No:       ".get_ref_for_grn_no($myrow["trans_no"]),0,'L', 0, 2,402,125,true);
