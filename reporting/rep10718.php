...
if($pref['batch'] == 1){
	...
	$cols = array(4, 60, 175, 260,260, 315, 355, 395, 450, 475);
	...
	$aligns = array('left',	'left',	'left',	'left',	'right', 'center', 'right', 'right', 'right');
      ...
      //-------------code-Descr-Qty--uom--tax--prc--Disc-Tot--//
	$cols = array(4, 60, 315, 370, 410, 455, 470, 515);
...
//                $item=get_item($myrow2['stk_code']);
        ...
        $rep->MultiCell(400, 25, "".$sales_order['customer_ref'],0, 'L', 0, 2, 180,306, true);
        ...
        $memo = get_comments_string(ST_SALESINVOICE, $row['trans_no']);
			...
			{
				$rep->NewLine();
                $rep->MultiCell(400, 25, "".$memo,0, 'L', 0, 2, 380,306, true);
...
//		$rep->Amountcol(6, 7, $total_amount, $dec);
	...
	$pref=get_company_prefs();
			...
			$rep->MultiCell(400, 25, "Created By:__________________",0, 'L', 0, 2, 35,745, true);
