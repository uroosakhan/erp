...
function get_payment_terms_names_10771($id)
{
...
//					$rep->TextCol(3, 4,	$myrow2['units'], -2);
        ...
        $rep->font('bold');
        $rep->setfontsize(+10);
        $rep->MultiCell(100,15,"Amount In Words:",0,'L',0,0,75,720);
        $rep->MultiCell(200,15,"Total Amount To pay",0,'L',0,0,75,670);
        $rep->MultiCell(200,15,"Amount Received",0,'L',0,0,75,700);
        $rep->font();
        $rep->MultiCell(400,15,"Rupees ".$amount_in_words." Only",0,'L',0,0,75,735);
        $rep->setfontsize(+8);
