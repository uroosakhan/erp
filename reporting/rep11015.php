...
function print_deliveries()
{
	...
	$cols = array(1, 40, 100, 160, 350, 375, 420, 480);
...
//		_("Qty"));
	...
	for ($i = $from; $i <= $to; $i++)
	{
			...
			while ($myrow2=db_fetch($result))
			{
	    		...
	    		$qty_done = number_format2($myrow2["qty_done"],get_qty_dec($myrow2['stock_id']));
...
//                $item=get_item($myrow2['stk_code']);
					...
					$rep->TextCol(6, 7,$qty_done	, -2);

					$return_qty =$myrow2["quantity"]-$myrow2["qty_done"];


					$rep->TextCol(7, 8,number_format2($return_qty), -2);
			...
			if ($memo != "")
			{
				...
				$rep->MultiCell(320,20,$memo,0,'L',0,0,80,185);
...
//							$rep->TextCol(3, 7, _("Included") . " " . $tax_type_name . _("Amount") . ": " . $DisplayTax, -2);
		...
		$rep->MultiCell(150,15," Prepared By",1,'L',0,0,20,730);
		$rep->MultiCell(150,15," ",1,'L',0,0,20,745);
		$rep->MultiCell(150,15," ",1,'L',0,0,20,760);

		$rep->MultiCell(150,15," Approved By",1,'L',0,0,170,730);
		$rep->MultiCell(150,15,"",1,'L',0,0,170,745);
		$rep->MultiCell(150,15,"",1,'L',0,0,170,760);

		$rep->MultiCell(150,15," Acknowledged By",1,'L',0,0,320,730);
		$rep->MultiCell(150,15,"",1,'L',0,0,320,745);
		$rep->MultiCell(150,15,"",1,'L',0,0,320,760);

		$rep->MultiCell(120,15," Security Officer",1,'L',0,0,470,730);
		$rep->MultiCell(120,15,"",1,'L',0,0,470,745);
		$rep->MultiCell(120,15,"",1,'L',0,0,470,760);
