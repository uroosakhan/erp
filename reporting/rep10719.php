...
function print_invoices()
{
	...
	while($row = db_fetch($range))
	{
			...
			$rep->SetCommonData($myrow, $branch, $sales_order, $baccount, 10755, $contacts);
			$rep->SetHeaderType('Header10719');
			$rep->NewPage();
...
//			if (!$myrow['prepaid']) $rep->Font('bold');
    ...
    $rep->MultiCell(100, 8, "___________________", 0, 'L', 0,1,410,719, true);
    $rep->MultiCell(96, 8, "Released By", 0, 'C', 1,1,410,729, true);
