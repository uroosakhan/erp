...
//    display_error($destination);
    ...
    $cols = array(5, 83, 40, 160, 190,  190, 180, 350, 421, 480 ,545);
    ...
    $aligns = array('left', 'left', 'left',	'left',	'left',	'left',	'left',	'right', 'right', 'center');
    $rep->Font('bold');
    if ($dim == 2)
        $headers = array(_('Date'),	_('Counter'), _('Vou Ref #'),	_('Particulars'), _('')." ", _('')." ",
            _(''), _('Debit'),	_('Credit'), _('Balance'));
    elseif ($dim == 1)
        $headers = array(_('Date'),	_('Counter'), _('Vou Ref #'),	_('Particulars'), _('Dimension'), "", _(''),
            _('Debit'),	_('Credit'), _('Balance'));
    else
        $headers = array(_('Date'),	_('Counter'), _('Vou Ref #'),	_('Particulars'), "", "", _(''),
            _('Debit'),	_('Credit'), _('Balance'));
...
//        }
                ...
                $memo = get_comments_string($myrow['type'], $myrow['type_no']);
                    ...
                    $rep->LineTo($rep->leftMargin, 38.6 * $rep->lineHeight, $rep->leftMargin, $rep->row  +6.5);
                    $rep->LineTo($rep->pageWidth - $rep->rightMargin, 38.6 * $rep->lineHeight, $rep->pageWidth - $rep->rightMargin, $rep->row +6.5);
                    $rep->LineTo($rep->pageWidth - $rep->rightMargin - 95, 38.6 * $rep->lineHeight, $rep->pageWidth - $rep->rightMargin - 95, $rep->row+6.5 );
                    $rep->LineTo($rep->pageWidth - $rep->rightMargin - 179, 38.6 * $rep->lineHeight, $rep->pageWidth - $rep->rightMargin - 179, $rep->row+6.5 );
                    $rep->LineTo($rep->pageWidth - $rep->rightMargin - 265, 38.6 * $rep->lineHeight, $rep->pageWidth - $rep->rightMargin - 265, $rep->row +6.5);
                    $rep->LineTo($rep->pageWidth - $rep->rightMargin - 551, 38.6 * $rep->lineHeight, $rep->pageWidth - $rep->rightMargin - 551, $rep->row +6.5);
                    $rep->LineTo($rep->pageWidth - $rep->rightMargin - 659, 38.6 * $rep->lineHeight, $rep->pageWidth - $rep->rightMargin - 659, $rep->row  +6.5);
                    $rep->LineTo($rep->pageWidth - $rep->rightMargin - 721, 38.6 * $rep->lineHeight, $rep->pageWidth - $rep->rightMargin - 721, $rep->row  +6.5);
                    $rep->NewLine();
                   // $rep->Line($rep->row + 6);
