...
function print_invoices()
{
	...
	$cols = array(6, 25, 125, 170, 210, 250, 285, 320, 368,415,462, 550);
	$cols2 = array(6, 25, 125, 170, 210, 250,  285, 320, 368,415,462, 550);
...
//					$rep->TextCol(3, 4,	$myrow2['units'], -2);
					...
					if($sales_tax1)
					{
					$rep->TextCol(7, 8,	price_format($sales_tax1), -2);
