...
if ($divison == ALL_TEXT)
  ...
  if ($month == ALL_TEXT)
	...
	$headers = array(_('S#'), _('Code'), _('Account Title.'), _('C.N.I.C.No.'), _('Amount'));
...
//		$NetSalary = $myrow['basic_salary'] - $myrow['advance_deduction'] - $myrow['late_deduction'] - $myrow['tax'] + $myrow['Overtime'] ;
        ...
        {
        $rep->TextCol(0, 1, $myrow2['emp_id']);
        $rep->TextCol (1, 2, $empp['emp_code'] );
        $rep->TextCol (2, 3, $empp['emp_name']);
        $rep->TextCol(3, 4,$empp['emp_cnic'] );
