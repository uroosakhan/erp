...
function getTransactions($trans_no, $LessQty)
{
    $from = date2sql($from);
    $to = date2sql($to);
    $sql = "SELECT ".TB_PREF."stock_moves.stock_id, ".TB_PREF."stock_moves.qty,".TB_PREF."stock_moves.reference,".TB_PREF."stock_moves.batch, ".TB_PREF."stock_master.units,
...
$memo_ = get_comments_string_for_C_I(16,$trans_no);
    $rep->MultiCell(240, 50, $memo_ , 0, 'L', 0, 2, 50, 590, true);
...
//    $rep->AmountCol(5, 6, $amt_tot, $dec);
    ...
    $rep->AmountCol(2, 3, abs($qty_total), $dec);
