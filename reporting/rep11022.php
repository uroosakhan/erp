...
function print_deliveries()
{
    ...
    $cols = array(1, 35,100, 260,400,460);
...
//        }
$rep->MultiCell(250, 188,"".$memo, 0, 'L', 0, 2, 440,520, true); //second
$rep->MultiCell(250, 188,"".$memo, 0, 'L', 0, 2, 440,100, true); //second
...
//                $rep->NewLine(1);
        ...
        $rep->MultiCell(770, 30, "".$sales_order['f_text2'], 0, 'L', 0,1,143,124, true);
        		$loc1=get_item_location($sales_order['loc_code']);

         $rep->MultiCell(770, 30, "Deliver To: ", 0, 'L', 0,1,380,124, true);//second
        ...
        $rep->MultiCell(770, 30, "Gate copy:", 0, 'L', 0,1,40,349, true);
                $rep->MultiCell(10, 4, "", 1, 'L', 0,1,90,349, true);
                $rep->MultiCell(10, 4, "", 1, 'L', 0,1,179,349, true);
                $rep->MultiCell(10, 4, "", 1, 'L', 0,1,260,349, true);
                $rep->MultiCell(10, 4, "", 1, 'L', 0,1,90,363, true);
                $rep->MultiCell(10, 4, "", 1, 'L', 0,1,179,363, true);

          $rep->MultiCell(770, 30, "Customer copy:", 0, 'L', 0,1,110,349, true);
          $rep->MultiCell(770, 30, "factory copy:", 0, 'L', 0,1,200,349, true);
          $rep->MultiCell(770, 30, "Billing copy:", 0, 'L', 0,1,40,363, true);
            $rep->MultiCell(770, 30, "Accounts copy:", 0, 'L', 0,1,110,363, true);
        ...
        $rep->MultiCell(770, 30, "Received By:", 0, 'L', 0,1,357,352, true);
        ...
        $rep->MultiCell(770, 30, "".$sales_order['f_text2'], 0, 'L', 0,1,143,550, true);//second
         ...
         $rep->MultiCell(770, 30, "Deliver To: ", 0, 'L', 0,1,380,550, true);//second
        ...
        $rep->MultiCell(770, 30, "Prepared By:", 0, 'L', 0,1,40,780, true);//second
        ...
        $rep->MultiCell(770, 30, "Received By:", 0, 'L', 0,1,357,805 , true);//second
   $rep->MultiCell(770, 30, "Gate copy:", 0, 'L', 0,1,40,805, true);
                $rep->MultiCell(10, 4, "", 1, 'L', 0,1,90,805, true);
                $rep->MultiCell(10, 4, "", 1, 'L', 0,1,179,805, true);
                $rep->MultiCell(10, 4, "", 1, 'L', 0,1,260,805, true);
                $rep->MultiCell(10, 4, "", 1, 'L', 0,1,90,820, true);
                $rep->MultiCell(10, 4, "", 1, 'L', 0,1,179,820, true);

          $rep->MultiCell(770, 30, "Customer copy:", 0, 'L', 0,1,110,805, true);
          $rep->MultiCell(770, 30, "factory copy:", 0, 'L', 0,1,200,805, true);
          $rep->MultiCell(770, 30, "Billing copy:", 0, 'L', 0,1,40,820, true);
            $rep->MultiCell(770, 30, "Accounts copy:", 0, 'L', 0,1,110,820, true);
