...
function getTransactions_qty_amount($from, $stock_id, $week)
{
    ...
    elseif($week==1) {
        ...
        $mon_days = cal_days_in_month(CAL_GREGORIAN, $mo, $yr);
        $date1 = date('Y-m-d', mktime(0, 0, 0, $mo, 1, $yr));
        $e_date = date('Y-m-d', mktime(0, 0, 0, $mo, 8, $yr));
    }
    elseif($week==2) {
        $mo = date('m', strtotime($from));
        $yr = date('Y', strtotime($from));
...
//    $fromcust = $_POST['PARAM_6'];
    ...
    if($p_q==1) {
        if ($mon_days == 31)
            $headers = array(_(''),
                $show1, $show2, $show3, $show4, $show5, $show6, $show7, "(Week 1) ", $show8, $show9, $show10,
                $show11, $show12, $show13, $show14, "(Week 2) ", $show15, $show16, $show17, $show18, $show19,
                $show20, $show21, "(Week 3) ", $show22, $show23, $show24, $show25, $show26, $show27, $show28,
                $show29, $show30, $show31, "(Week 4) ", "Quantity", "Total", /*"Total",*/ "Disc", "Cost", "Net Profit", " Net % ");
        else
            $headers = array(_(''),
                $show1, $show2, $show3, $show4, $show5, $show6, $show7, "(Week 1) ", $show8, $show9, $show10,
                $show11, $show12, $show13, $show14, "(Week 2) ", $show15, $show16, $show17, $show18, $show19,
                $show20, $show21, "(Week 3) ", $show22, $show23, $show24, $show25, $show26, $show27, $show28,
                $show29, $show30, "  ", "(Week 4)", "Quantity", "Total", /*"Total",*/ "Disc", "Cost", "Net Profit", " Net % ");
    }
    else
    {
        if ($mon_days == 31)
            $headers = array(_(''),
                $show1, $show2, $show3, $show4, $show5, $show6, $show7, "(Week 1) ", $show8, $show9,
                $show10, $show11, $show12, $show13, $show14, "(Week 2) ", $show15, $show16, $show17,
                $show18, $show19, $show20, $show21, "(Week 3) ", $show22, $show23, $show24, $show25,
                $show26, $show27, $show28, $show29, $show30, $show31, "(Week 4) ", "Qty", "Total", "Disc", "Cost", "Net Profit", " Net % ");
        else
            $headers = array(_(''),
                $show1, $show2, $show3, $show4, $show5, $show6, $show7, "(Week 1) ", $show8, $show9,
                $show10, $show11, $show12, $show13, $show14, "(Week 2) ", $show15, $show16, $show17,
                $show18, $show19, $show20, $show21, "(Week 3) ", $show22, $show23, $show24, $show25,
                $show26, $show27, $show28, $show29, $show30, "  ", "(Week 4) ", "Qty", "Total", "Disc", "Cost", "Net Profit", " Net % ");
    }
//-------------------for weeks-----------------//
    ...
    if($p_q==1) {
        if ($week == 1) {
            $headers = array(_(''),
                ...
                '', '', '', '', '', '', '', '', '', '',
                '', '', '', '', '', '', '', '', '', '',
                '', "Quantity", "Total", /*"Total",*/ "Disc", "Cost", "Net Profit", " Net % ");
        } elseif ($week == 2) {
            $headers = array(_(''),
                '', '', '', '', '', '', '', $show8, $show9, $show10,
            ...
            if ($mon_days == 31)
                $headers = array(_(''),
                    ...
                    $show31, "Quantity", "Total", /*"Total",*/ "Disc", "Cost", "Net Profit", " Net % ");
            else
                $headers = array(_(''),
                    '', '', '', '', '', '', '', '', '', '',
                    '', '', '', '', '', '', '', '', '',
                    '', '', $show22, $show23, $show24, $show25, $show26, $show27, $show28,
                    $show29, $show30, "  ", "Quantity", "Total", /*"Total",*/ "Disc", "Cost", "Net Profit", " Net % ");
        }
    }
    else
    {
...
//--------------month wise end------------//
        ...
        if($week==1)
        {
            ...
            $rep->TextCol(6, 7, $tot_per6);
            $rep->TextCol(7, 8, $tot_per7);
            $rep->AmountCol(34, 35, $grand_total_w1, 0);
        }
        elseif($week==2)
        {
            $rep->TextCol(0, 1, _('Grand Total'));
            ...
            $rep->AmountCol(34, 35, $grand_total_w2, 0);
        }
        elseif($week==3)
        {
            $rep->TextCol(0, 1, _('Grand Total'));
            ...
            $rep->AmountCol(34, 35, $grand_total_w3, 0);
        }
        elseif($week==4)
        {
            $rep->TextCol(0, 1, _('Grand Total'));
            ...
            $rep->AmountCol(34, 35, $grand_total_w4, 0);
        }
        //-----------------weeks end---------------------//
...
//---------------------for weeks------------------------//
        if($week==1)
        {
            ...
            $rep->AmountCol(34, 35, $invoices_total_w1, 0);
        }
        elseif($week==2)
        {
            $rep->TextCol(0, 1, _('No Of Invoices'));
            ...
            $rep->AmountCol(34, 35, $invoices_total_w2, 0);
        }
        elseif($week==3)
        {
            $rep->TextCol(0, 1, _('No Of Invoices'));
            ...
            $rep->AmountCol(34, 35, $invoices_total_w3, 0);
        }
        elseif($week==4)
        {
            $rep->TextCol(0, 1, _('No Of Invoices'));
            ...
            $rep->AmountCol(34, 35, $invoices_total_w4, 0);
        }
        ...
        if($week==1)
        {
            ...
            $rep->AmountCol(34, 35, $overall_discount_w1, 0);
        }
        elseif($week==2)
        {
            $rep->TextCol(0, 1, _('Overall Discount'));
            ...
            $rep->AmountCol(34, 35, $overall_discount_w2, 0);
        }
        elseif($week==3)
        {
            $rep->TextCol(0, 1, _('Overall Discount'));
            ...
            $rep->AmountCol(34, 35, $overall_discount_w3, 0);
        }
        elseif($week==4)
        {
            $rep->TextCol(0, 1, _('Overall Discount'));
            ...
            $rep->AmountCol(34, 35, $overall_discount_w4, 0);
        }
//-------------------for week end----------------//
        //marina
        $rep->Line($rep->row - 8);
        ...
        if($week==0) {
            ...
            $rep->AmountCol(38, 39, $total_line_disc, 0);
            $rep->AmountCol(39, 40, $total_cost, 0);
//            $rep->AmountCol(38, 39, $grand_total, 0);
            $rep->AmountCol(40, 41, $total_net_profit, 0);
        ...
        if($week==1)
        {
            ...
            $rep->AmountCol(33, 34, $total_cost, 0);
            $rep->AmountCol(34, 35, $grand_total_w1, 0);
            $rep->AmountCol(35, 36, $total_net_profit_w1, 0);
        }
        elseif($week==2)
        {
            $rep->TextCol(0, 1, _('Grand Total'));
            ...
            $rep->AmountCol(33, 34, $total_cost, 0);
            $rep->AmountCol(34, 35, $grand_total_w2, 0);
            $rep->AmountCol(35, 36, $total_net_profit_w2, 0);
        }
        elseif($week==3)
        {
            $rep->TextCol(0, 1, _('Grand Total'));
            ...
            $rep->AmountCol(33, 34, $total_cost, 0);
            $rep->AmountCol(34, 35, $grand_total_w3, 0);
            $rep->AmountCol(35, 36, $total_net_profit_w3, 0);
        }
        elseif($week==4)
        {
            $rep->TextCol(0, 1, _('Grand Total'));
            ...
            $rep->AmountCol(33, 34, $total_cost, 0);
            $rep->AmountCol(34, 35, $grand_total_w4, 0);
            $rep->AmountCol(35, 36, $total_net_profit_w4, 0);
        }
        //-----------------weeks end---------------------//
...
//----------------moth wise end-----------------//
        ...
        if($week==1)
        {
            ...
            $rep->TextCol(6, 7, round($tot_per6 - $dis['per06']));
            $rep->TextCol(7, 8, round($tot_per7 - $dis['per07']));
            $rep->AmountCol(34, 35, $grand_total_w1 - $overall_discount_w1, 0);
        }
        elseif($week==2)
        {
            $rep->TextCol(0, 1, _('Net Total'));
            ...
            $rep->AmountCol(34, 35, $grand_total_w2 - $overall_discount_w2, 0);
        }
        elseif($week==3)
        {
            $rep->TextCol(0, 1, _('Net Total'));
            ...
            $rep->AmountCol(34, 35, $grand_total_w3 - $overall_discount_w3, 0);
        }
        elseif($week==4)
        {
            $rep->TextCol(0, 1, _('Net Total'));
            ...
            $rep->AmountCol(34, 35, $grand_total_w4 - $overall_discount_w4, 0);
        }
        //------------for week end-----------//
...
//-------------------------for revenue--------------------------------//
    if($p_q==1)
    {
        ...
        //-------------for weeks end-------------//
        if($week==1) {
            $rep->TextCol(25, 32, "Net Revenue");
            $rep->AmountCol(33, 35, $grand_total_w1 - $overall_discount_w1, 0);
        }
        if($week==2) {
            $rep->TextCol(25, 32, "Net Revenue");
            $rep->AmountCol(33, 35, $grand_total_w2 - $overall_discount_w2, 0);
        }
        if($week==3) {
            $rep->TextCol(25, 32, "Net Revenue");
            $rep->AmountCol(33, 35, $grand_total_w3 - $overall_discount_w3, 0);
        }
        if($week==4) {
            $rep->TextCol(29, 32, "Net Revenue");
            $rep->AmountCol(33, 35, $grand_total_w4 - $overall_discount_w4, 0);
        }
        //-------------for weeks end-------------//
        $rep->Font('');
        $rep->Line($rep->row - 8);
...
//-------------------------for expenses----------------------------------//
        ...
        while ($expenses_db=db_fetch($per_balance)) {
            ...
            if($expenses_db['t_amount']==0 )
                continue;
            $rep->Font('bold');
            $rep->TextCol(28, 34, $expenses_db['name']);
            $rep->AmountCol(36, 39, $expenses_db['t_amount'], 0);
            $rep->Font('');
            $rep->Line($rep->row - 1);
            $rep->NewLine();
            ...
            while ($exp_detail_db=db_fetch($exp_detail)) {
                if( $exp_detail_db['amt_t']==0 )
                    continue;
                $rep->TextCol(28, 34, $exp_detail_db['account_name']);
                $rep->AmountCol(36, 39, $exp_detail_db['amt_t'], 0);
                $rep->NewLine();
            }
        ...
        $rep->NewLine();
        $rep->Font('bold');
        $rep->TextCol(28, 34, "Total Expenses");
        $rep->AmountCol(36, 39, $expenses_total, 0);
        ...
        $rep->Line($rep->row - 6);
        $rep->NewLine(+1.5);
        $rep->TextCol(28, 34, "Grand Amount");
        $rep->AmountCol(36, 39, $End_Balance, 0);
        $rep->Line($rep->row - 8);
        $rep->Font('');
