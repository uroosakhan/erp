...
if($db_connections[$_SESSION["wa_current_user"]->company]["name"] == 'ASHARDB') {
	...
	$cols = array(4, 60, 225, 430, 450, 400);
	...
	$cols = array(4, 60, 210, 300, 325, 385, 450, 515);
...
if($db_connections[$_SESSION["wa_current_user"]->company]["name"] == 'ASHARDB') {
$rep->row = $rep->bottomMargin + (8.5 * $rep->lineHeight);
$rep->Font('b');

$rep->MultiCell(300, 148, _("Customer Signature") , 0, 'L', 0, 2, 60,795, true);
$rep->MultiCell(300, 148, _("_________________________") , 0, 'L', 0, 2, 40,785, true);



$rep->MultiCell(300, 148, _("_________________________") , 0, 'L', 0, 2, 410,785, true);

$rep->MultiCell(300, 148, _("Supplier Signature") , 0, 'L', 0, 2, 430,795, true);



                        $rep->TextCol(2, 3, _("Total Qty"), -2);
			$rep->TextCol(3, 4,price_format($total_qtys), -2);
				//$rep->NewLine();
$rep->Font('');
$rep->MultiCell(300, 148, _("_______________") , 0, 'L', 0, 2, 490,680, true);

$rep->MultiCell(300, 148, _("Recieved goods in good conditions on behalf of buyer named above") , 0, 'L', 0, 2, 40,720, true); //3
}else{
