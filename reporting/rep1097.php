...
$pref = get_company_prefs();
	...
	$cols = array(4,  100,  300,  450);

	// $headers in doctext.inc
	$aligns = array('left',	'left',	'right', 'left');
     }
     else{
         	$cols = array(4,  100,  300,  450);
...
//		    	$qty=$myrow2['quantity'];
			...
			if ($Net != 0.0 || !is_service($myrow2['mb_flag']) || !$SysPrefs->no_zero_lines_amount())
			{
			   ...
			   $rep->Amountcol(2, 3,	$myrow2["unit_price"] ,$dec);
			   $rep->Amountcol(3, 4,	$myrow2['quantity'] * $myrow2["unit_price"] ,$dec);
