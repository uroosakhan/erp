...
//		$rep->TextCol(6, 7,	$DisplaySubTot, -2);
		...
		if ($myrow['freight_cost'] != 0.0)
		{
            ...
            $rep->MultiCell(100, 5, price_format($DisplayFreight),0, 'R', 0, 2, 359, 630, true);
...
$grand_total =($SubTotal+$DisplayTax + $myrow["freight_cost"] )  - $myrow['so_advance'];
$rep->MultiCell(600, 5, "Total Value Exclusive of Sales Tax ",0, 'L', 0, 2, 220, 620, true);
$rep->MultiCell(600, 5, price_format($SubTotal),0, 'L', 0, 2, 423, 620, true);
...
$rep->MultiCell(500, 5, "Amount Received",0, 'L', 0, 2, 220, 668, true);

$rep->MultiCell(50, 5, price_format($myrow['so_advance']),0, 'R', 0, 2, 410, 668, true);

$rep->MultiCell(50, 5, "Grand Total",0, 'L', 0, 2, 220, 681, true);
$rep->MultiCell(50, 5, price_format($grand_total ),0, 'R', 0, 2, 410, 681, true);

    $rep->setfontsize (14);
	$rep->Font('bold');
// 	$rep->MultiCell(300, 5, $rep->company['coy_name'], 0, 'L', 0, 2, 48, 37, true);
	$rep->Font();
//	$rep->setfontsize (8);
