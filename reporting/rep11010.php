...
$cols = array(4, 40, 100, 240, 325, 385, 450, 515);
	...
	for ($i = $from; $i <= $to; $i++)
	{
			...
			if ($packing_slip == 0)
			{
				...
				$rep->NewLine();
				$rep->TextCol(4, 6, _("Total Nos of Packing :"), -2);
...
/*				$tax_items = get_trans_tax_details(ST_CUSTDELIVERY, $i);
		...
		*/		
		...
		$rep->TextCol(0, 4, _("  Received the above goods in full and 
"), +100);
$rep->NewLine();
$rep->TextCol(0, 4, _("  to our entire satisfaction and acknowledge.: "), +100);
	//	$rep->TextCol(3, 7, _("          APPLIED PRODUCTS SERVICES (PVT) LTD"), +100);
