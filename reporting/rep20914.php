...
function print_po()
{
	...
	$cols = array(4, 60, 245, 320, 380, 490, 450, 515);
...
$str=str_replace("&amp","",$myrow['comments']);
			$rep->Font('bold');
			$rep->MultiCell(800, 25, "TERM AND CONDITIONS:  ".$str,0, 'L', 0, 2, 40,270, true);		
		}
...
//
		...
		$rep->MultiCell(210, 20, "" ,0, 'R', 1, 2, 360,520, true);
