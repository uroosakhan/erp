...
function get_po($order_no)
{
    $sql = "SELECT ".TB_PREF."purch_orders.*, ".TB_PREF."suppliers.supp_name,  "
        ...
        ".TB_PREF."suppliers.gst_no AS tax_id,
   		".TB_PREF."suppliers.curr_code, ".TB_PREF."suppliers.payment_terms,
   		 ".TB_PREF."locations.location_name,
   		".TB_PREF."suppliers.address, ".TB_PREF."suppliers.contact, 
   		".TB_PREF."purch_orders.requisition_no AS number,".TB_PREF."purch_orders.reference,
...
//    $aligns2 = array('center',	'left',	'left', 'left', 'left', 'left', 'left', 'left', 'left');
    ...
    if ($email == 0)
        $rep = new FrontReport(_(''), "PurchaseOrderBulk", user_pagesize(), 9, $orientation);
    if ($orientation == 'L')
...
//            $rep->TextCol(3, 4,	$DisplayQty, -2);
          //  $rep->TextCol(3, 4, $myrow2['units'], -2);
            ...
            $rep->TextCol(4, 5, price_format($gross_amt) , -2);
...
//                $rep->TextCol(6, 7,	$DisplayTax, -2);
            ...
            $rep->MultiCell(825, 30, "" . $myrow['Comments1'], 0, 'L', 0, 2, 80, 732, true);
            $rep->MultiCell(825, 30, "" . $myrow['Comments2'], 0, 'L', 0, 2, 80, 756, true);
