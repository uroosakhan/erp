...
function print_invoices()
{
	...
	$cols = array(7, 35, 90, 100, 125, 150,175,197,230,270);
	// $headers in doctext.inc
	$aligns = array('left',	'center',	'left', 'left','left','left','left','left');
	...
	if ($email == 0)
	{
		...
		$rep->SetHeaderType('Header107778');
		$rep->currency = $cur;
		$rep->Font();
	...
	for ($i = $from; $i <= $to; $i++)
	{
		...
		while ($myrow2=db_fetch($result))
		{
			...
			if ($myrow2["discount_percent"]==0)
				...
				$DisplayDiscount = $myrow2["discount_percent"] ;

			$discount=$DisplayDiscount*$Net;
			...
			if ($Net != 0.0 || !is_service($myrow2['mb_flag']) || !isset($no_zero_lines_amount) || $no_zero_lines_amount == 0)
			{
				...
				$rep->TextCol(6, 7,number_format2($discount)	, -2);

				$total_price_incl_disc=abs($Net-$discount);
				$rep->TextCol(7, 8,number_format2($total_price_incl_disc)	, -2);

			}

			$rep->NewLine(0.2);
//			$rep->MultiCell(500, 148, (" ..........................................................................................................") , 0, 'L', 0, 2, 1,140, true);
		...
		$rep->MultiCell(200, 10,"i)Exchange with receipt only within 7 days of purchase. " , 0, 'L', 0, 2, 6,270, true);
		$rep->MultiCell(200, 10,"ii)No Refund. ", 0, 'L', 0, 2, 6,280, true);
		...
		$DisplayTotal = number_format2($sign*($myrow["ov_freight"] + $myrow["ov_gst"] +
				$myrow["ov_amount"]+$myrow["ov_freight_tax"]-$myrow["discount2"]),0);
		...
		$rep->TextCol(4, 5, $myrow["discount2"], -2);
		$rep->NewLine();
		$rep->Font('bold');
		$rep->fontSize += 3;
		$rep->TextCol(0, 3, _("TOTAL RECEIPT"), - 2);
		$rep->TextCol(4, 6, $DisplayTotal, -2);
		$rep->fontSize -= 3;
...
//		$rep->TextCol(0, 5, _("......................................Powered by Hisaab.pk ................................"), -2);
		...
		$rep->MultiCell(500, 148, ("....................Powered by Hisaab.pk ....................") , 0, 'L', 0, 2, 1,307, true);
