...
function print_invoices()
{
	...
	$cols = array(0,25, 55, 150, 180, 215, 260, 310,360,410, 465);
...
//	$aligns1 = array('left',	'left',	'left', 'left', 'left', 'left', 'left', 'left', 'left','right');
	...
	while($row = db_fetch($range))
	{
			...
			$rep->SetHeaderType('Header107055');
			$rep->NewPage();
		...
		$s_no=0;
			...
			while ($myrow2=db_fetch($result))
			{
                ...
                $rep->TextColLines(1, 2, $myrow2['h_text6'], -2);
				$newrow = $rep->row;
				$rep->row = $oldrow;
...
//		$rep->MultiCell(340, 150, "".$sales_order['h_text2'] , 0, 'L', 0, 2, 60,548, true);
