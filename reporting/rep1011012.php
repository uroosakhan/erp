...
//		$salesfolk = get_salesman_name($folk);
    ...
    $rep = new FrontReport(_('P.O.Delivery with Unit Price (include tax)'), "CustomerBalancesDetailed", user_pagesize(), 9, $orientation);
    if ($orientation == 'L')
...
//	$result = db_query($sql, "The customers could not be retrieved");
	...
	while ($myrow = db_fetch($GetRecord))
	{
        ...
        $catt = $myrow['order_no'];
        $total2=  $myrow['quantity_ordered'] * ($myrow['unit_price']*1.19);
        ...
        $rep->TextCol(4, 5, $myrow['unit_price']*1.19);
