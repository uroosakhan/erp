...
function print_invoices()
{
	...
	$cols = array(0, 45, 240, 350,437 ,500);
...
$total_ =abs($discount-$myrow2["unit_price"]);
				...
				$oldrow = $rep->row;
				 $rep->TextCol(4, 3,$myrow2['discount1']."".$myrow2['discount2'], -2);
					  $rep->TextCol(3, 4,"".$myrow2['text3'], -2);
// 	$rep->NewLine(-1);
               				 $rep->TextColLines(1, 2, $myrow2['text1'], -2);
              						$rep->NewLine(-2);
					  $rep->TextColLines(2, 3,$myrow2['text2'], -2);
