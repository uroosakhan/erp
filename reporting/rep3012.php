...
function print_inventory_purchase()
{
	...
	$cols = array(0, 80, 180, 225, 250, 360, 390, 430, 520);

	$headers = array(_('Item/Category'), _('Description'), _(''), _(''), _('Supplier'), _('Qty'), _('Unit Price'), _('Total'));
	if ($fromsupp != '')
		$headers[4] = '';
    ...
    $rep = new FrontReport(_('Item Purchase Summary Report'), "InventoryPurchasingReport", user_pagesize(), 9, $orientation);
    if ($orientation == 'L')
