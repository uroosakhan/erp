...
function get_invoices($customer_id, $to, $all=true,$types, $dim, $no_of_days, $columns)
{
    ...
    else
    {
           ...
           ov_amount + ov_gst + ov_freight + ov_freight_tax + ov_discount +	trans.gst_wh  + trans.supply_disc + trans.service_disc + trans.fbr_disc + trans.srb_disc + trans.discount1 - trans.discount2 - alloc)";
