...
function print_Chart_of_Accounts()
{
    ...
    $cols = array(2, 50, 180,317, 380, 440, 480);

    $headers1 = array(_('    Code'), _('                   '), _('                           '),_('      Centre'),_('      Centre'), _('      Rs'), _('        Rs'));
...
//    $rep->MultiCell(170, 30, $trans_no."++++".$type ,0, 'L', 0, 2, 90,199, true);
    ...
    // display_error($myrow1["person_type_id"]);
        ...
        $as_dimen2 =  get_dimension_new22($myrow1['dimension2_id']);
...
else
{
 ...
 $rep->NewLine(-1);
   ...
   $rep->TextColLines(3, 4,	$as_dimen, -2);
        $rep->TextColLines(4, 5,	$as_dimen2, -2);
