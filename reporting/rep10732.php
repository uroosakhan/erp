...
if($pref['batch'] == 1){
	...
	$aligns = array('left',	'left',	'left',	'left',	'right', 'center', 'right', 'right', 'right');
      ...
      //-------------code-Descr-Qty--uom--tax--prc--Disc-Tot--//
	$cols = array(4, 60, 245, 300, 345, 385, 450, 515);
...
//                $item=get_item($myrow2['stk_code']);
					...
					$rep->TextCol(8, 9,	$DisplayNet, -2);
						$rep->TextCol(0, 10,	"____________________________________________________________________________________________________________", -2);
...
$rep->NewLine();
		...
		$rep->MultiCell(400, 25, "Customer Signature:__________________",0, 'L', 0, 2, 353,605, true);
    		...
    		while ($tax_item = db_fetch($tax_items))
    		{
				...
				$rep->TextCol(3, 5, _("TOTAL DUE"), -2);
				$rep->Amountcol(5, 6, $total_amount + $DisplayTax, $dec);
				$rep->SetTextColor(61, 172, 227);

 		$rep->MultiCell(210, 20, "" ,0, 'C', 1, 2, 358,522, true);
