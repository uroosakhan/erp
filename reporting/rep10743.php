...
function print_invoices()
{
	...
	$cols = array(4, 44,80, 195, 230 ,260, 295 , 325, 360, 427, 460, 490, 500);
...
//        $rep->multicell(50,35,"Closing Bal:",0,'l',0,0,415,727);
      ...
      //  $rep->multicell(200,10,"Opening Balance:",0,'L',0,0,344,115);
        ...
        $rep->multicell(200,10,"SO No:",0,'L',0,0,344,145);
           $rep->multicell(800,10,"Supplier Name:"."Global Brandz Pakistan",0,'L',0,0,344,169);
...
//        $rep->multicell(170,20," ".get_user_name_1($prepared_by),1,'L',0,0,115,650);
		...
		$rep->NewLine(-11);
//		$rep->TextCol(7, 9, $rep->formData['prepaid'] ? _("Transportation Exp 2.0%.") : _("TOTAL INVOICE"). ' ' . $rep->formData['curr_code'], - 2);

//		$rep->TextCol(9, 11, $net_amount1, -2);
//		$rep->TextCol(9, 11, $DisplayTotal, -2);
//		$amount_in_words = convert_number_to_words($DisplayTotal);
		$rep->MultiCell(450,15,"Amount In Rupees:   ".convert_number_to_words($net_amount1)." Only",0,'L',0,0,45,430);
		...
		$rep->MultiCell(450,15,"".$DisplayTotal,0,'L',0,0,436,555);
		$rep->MultiCell(450,15,"Total",0,'L',0,0,305,555);
	$rep->MultiCell(450,15,"Grand Total",0,'L',0,0,280,395);
	$rep->MultiCell(300,15,"",1,'L',1,0,265,392);
		$rep->MultiCell(770, 30, "Authorised Signatures:", 0, 'L', 0,1,350,650, true);

		$net_17 = $DisplayTotal * 0.17;
		$net_0 = $DisplayTotal ;

		$rep->MultiCell(230, 70, "", 1, 'L', 0,1,300,500, true);
		$rep->MultiCell(230, 70, "Net Amount For 17%", 0, 'L', 0,1,305,505, true);
		$rep->MultiCell(230, 70, "---", 0, 'L', 0,1,450,505, true);
		$rep->MultiCell(230, 70, $net_0, 0, 'L', 0,1,450,520, true);
		$rep->MultiCell(230, 70, "Net Amount For 0%", 0, 'L', 0,1,305,520, true);
		$rep->MultiCell(230, 70, "Net Amount For Exempted", 0, 'L', 0,1,305,535, true);
		...
		$rep->MultiCell(770, 30, "Recieved By:", 0, 'L', 0,1,40,650, true);
		$rep->MultiCell(450,15,"".$DisplayTotal,0,'L',0,0,522,395);
        $rep->MultiCell(230, 19, "", 1, 'L', 0,1,300,500, true);
        $rep->MultiCell(230, 15, "", 1, 'L', 0,1,300,519, true);
        $rep->MultiCell(230, 20, "", 1, 'L', 0,1,300,550, true);
        $rep->MultiCell(110, 70, "", 1, 'L', 0,1,300,500, true);
