...
// 			$rep->TextCol(3, 4,	$myrow2['units'], -2);
		...
		$DisplayTotal = number_format2($sign*($myrow["ov_freight"] + $myrow["ov_gst"] +
			$myrow["ov_amount"] + $myrow["ov_freight_tax"] - $myrow["discount1"] - $myrow["discount2"] + $total_tax),$dec);
		$rep->Font('bold');
...
$rep->MultiCell(280, 25, "4- official receipt must be obtained for cash payment otherwise company will not                     responsible for payments",0, 'L', 0, 2, 50,678, true);
