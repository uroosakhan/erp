...
function print_sales_quotations()
{
	...
	$cols = array(4, 60, 250, 300, 325, 385, 450, 515);
	...
	for ($i = $from; $i <= $to; $i++)
	{
		...
		$rep->SetHeaderType('Header10710111');
		$rep->NewPage();
...
//			$rep->TextColLines(1, 3, "TERM AND CONDITIONS:  ".$myrow['comments'], -2);
		}
...
//		$rep->NewLine(+12);
		...
		$rep->MultiCell(220, 20, "" ,0, 'C', 1, 2, 340,545, true);
