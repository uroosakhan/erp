	...
	if ($prev_balance != 0.0 || $rows != 0)
	{
		...
		if ($rows > 0)
		{
			...
			while ($myrow=db_fetch($trans))
			{
				...
				{
		$rep->LineTo($rep->leftMargin, 39.6 * $rep->lineHeight ,$rep->leftMargin, $rep->row - 2);
        $rep->LineTo($rep->pageWidth - $rep->rightMargin,39.6 * $rep->lineHeight,$rep->pageWidth - $rep->rightMargin, $rep->row - 2);
        $rep->LineTo($rep->pageWidth - $rep->rightMargin - 85, 39.6* $rep->lineHeight, $rep->pageWidth - $rep->rightMargin - 85, $rep->row - 2);
        $rep->LineTo($rep->pageWidth - $rep->rightMargin - 175, 39.6 * $rep->lineHeight, $rep->pageWidth - $rep->rightMargin - 175, $rep->row - 2);
        $rep->LineTo($rep->pageWidth - $rep->rightMargin - 265, 39.6 * $rep->lineHeight, $rep->pageWidth - $rep->rightMargin - 265, $rep->row - 2);
        $rep->LineTo($rep->pageWidth - $rep->rightMargin - 507, 39.6 * $rep->lineHeight, $rep->pageWidth - $rep->rightMargin - 507, $rep->row - 2);
        $rep->LineTo($rep->pageWidth - $rep->rightMargin - 645, 39.6 * $rep->lineHeight, $rep->pageWidth - $rep->rightMargin - 645, $rep->row - 2);
        $rep->LineTo($rep->pageWidth - $rep->rightMargin - 715, 39.6 * $rep->lineHeight, $rep->pageWidth - $rep->rightMargin - 715, $rep->row - 2);
        ...
        $rep->LineTo($rep->leftMargin, 39.6* $rep->lineHeight ,$rep->leftMargin, $rep->row-8);
        $rep->LineTo($rep->pageWidth - $rep->rightMargin,39.6* $rep->lineHeight,$rep->pageWidth - $rep->rightMargin, $rep->row-8);
        $rep->LineTo($rep->pageWidth - $rep->rightMargin - 85, 39.6* $rep->lineHeight, $rep->pageWidth - $rep->rightMargin - 85, $rep->row-8);
        $rep->LineTo($rep->pageWidth - $rep->rightMargin - 175, 39.6 * $rep->lineHeight, $rep->pageWidth - $rep->rightMargin - 175, $rep->row-8);
        $rep->LineTo($rep->pageWidth - $rep->rightMargin - 265, 39.6 * $rep->lineHeight, $rep->pageWidth - $rep->rightMargin - 265, $rep->row-8);
        $rep->LineTo($rep->pageWidth - $rep->rightMargin - 507, 39.6 * $rep->lineHeight, $rep->pageWidth - $rep->rightMargin - 507, $rep->row-8);
        $rep->LineTo($rep->pageWidth - $rep->rightMargin - 645, 39.6 * $rep->lineHeight, $rep->pageWidth - $rep->rightMargin - 645, $rep->row-8);
        $rep->LineTo($rep->pageWidth - $rep->rightMargin - 715, 39.6 * $rep->lineHeight, $rep->pageWidth - $rep->rightMargin - 715, $rep->row-8);
