...
function print_po()
{
    ...
    $cols = array(5, 30,146, 290, 340, 400, 470);

    // $headers in doctext.inc
    $aligns = array('left',	'left','CENTER',	'CENTER',	'left', 'left', 'left', 'left');
...
//			else
       ...
       //	$rep->TextCol(2, 3,	sql2date($myrow2['delivery_date']), -2);
          ...
          $rep->NewLine(-2);
           ...
           // $rep->NewLine(-2);
            $rep->TextCol(2, 3,$myrow2['text2']	, -2);
           // $rep->NewLine(+2);
...
//                $rep->TextCol(6, 7,	$DisplayTax, -2);
        ...
        //$rep->TextCol(3, 6, _("TOTAL PO"), - 2);
         $rep-> AmountCol (6, 7,	$DisplayTotal + $DisplayTax, $dec);
...
// 	$rep->MultiCell(230, 60, "", 1, 'L', 0,1,350,490, true);
    ...
    $rep->MultiCell(285, 15, "For Bin Naeem  Pvt.Ltd ", 1, 'C', 0,1,295,750, true);
    ...
    $rep->MultiCell(140, 160, "", 1, 'L', 0,1,185,250, true);//size

    $rep->MultiCell(45, 160, "", 1, 'L', 0,1,372.5,250, true);//material/qty


    $rep->MultiCell(84, 160, "", 1, 'L', 0,1,495,250, true);//unit
...
// 	$rep->MultiCell(535, 50, "", 1, 'L', 0,1,45,400, true);//rate
  ...
  //  $rep->MultiCell(255, 20, "adding life and value to your property", 0, 'C', 0,1,195,60, true);
    ...
    $rep->Font('bold');
    $rep->Font('italic');
    $rep->MultiCell(255, 20, "Purchase Order", 0, 'C', 0,1,180,75, true);
    if ($email == 0)
        $rep->End();
}
