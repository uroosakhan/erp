...
//$month_name = get_month_name($month);
	...
	$cols = array(0, 35, 90, 125, 130, 200, 230, 270, 320, 360, 410, 460, 510, 565);
...
$orientation = 'L';
    $rep = new FrontReport(_('Sheet Of Leave'), "SupplierBalances", user_pagesize(), 10, $orientation);
    if ($orientation == 'L')
...
//		$rep->fontSize += 2;
	 ...
	 $rep->TextCol(2, 3, $myrow['from_date'], $dec);
		...
		$rep->TextCol(7, 9, $myrow['no_of_leave']);
		$rep->TextCol(9, 11, $myrow['reason']);
