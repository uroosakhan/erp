...
function print_sales_quotations()
{
	...
	$cols = array(6, 50, 200, 255, 310,  400, 460);
	...
	for ($i = $from; $i <= $to; $i++)
	{
		...
		$rep->SetHeaderType('Header11100011');
		$rep->currency = $cur;
		$rep->Font();
...
$rep->TextCol(0, 1,	"   ".$s++, -2);
			...
			if ($Net != 0.0 || !is_service($myrow2['mb_flag']) || !isset($no_zero_lines_amount) || $no_zero_lines_amount == 0)
			{
				...
				$rep->TextCol(2, 3,	$myrow2['text4'], -2);
				$rep->TextCol(4, 5,	$DisplayQty." ".$myrow2['units'], -2);
...
// $rep->MultiCell(525, 30, "Hope that the price, terms and conditions shall help you to generate the order in our favor." ,0, 'L', 0, 2, 40,800, true);//S.no
        $rep->Font('b');
        $rep->MultiCell(525, 30, "TERMS & CONDITIONS :-" ,0, 'L', 0, 2, 40,720, true);//S.no
