...
function print_invoices()
{
	...
	$cols = array(1, 30, 160, /*170, 210, 250,*/ 210, 280, 360,440, 550);
	$cols2 = array(1, 30, 160, /*170, 210, 250, */ 210, 280, 360,440, 550);
	// $headers in doctext.inc
	$aligns = array('left','left','right','right','right','right','right','right','right','right');
	$aligns2 = array('left','left','right','right','right','right','right','right','right','right');
