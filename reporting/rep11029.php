...
// 		 $rep->TextCol(1, 2,	get_category_name($myrow2['category_id']) ." / ".$myrow2['StockDescription']." / ".$item['text1']." / ".$item['text2']." / ".$item['long_description'], -2);
	            $rep->TextCol(1, 2,	"Make:".get_category_name($myrow2['category_id']), -2);
					$rep->NewLine();
				$rep->TextCol(1, 2,	"Model:".$myrow2['description'], -2);
					$rep->NewLine();
				$rep->TextCol(1, 2,	"Description:".$item['long_description']." ".$item['text1']." ".$item['text2'], -2);
...
//                $item=get_item($myrow2['stk_code']);
        ...
        // $rep->MultiCell(115, 15, "".$myrow['reference'], 0, 'L', 0, 2, 450,207, true);
                $rep->MultiCell(180, 25, "", 1, 'L', 0, 2, 385,200, true);
                        $rep->MultiCell(180, 25, "", 1, 'L', 0, 2, 385,225, true);
                        $rep->MultiCell(180, 25, "", 1, 'L', 0, 2, 385,250, true);
                        $rep->MultiCell(60, 75, "", 1, 'L', 0, 2, 385,200, true);
...
//
//
//   $user =get_user_id($myrow['order_'],ST_SALESORDER);
    $rep->MultiCell(200, 25, "For :" ,0, 'L', 0, 2, 50,805, true);
    // $this->MultiCell(170, 150, "For :  ", 0, 'L', 0, 2, 420,760, true);
$rep->fontSize += 8;
	$rep->Font('b');
 $rep->MultiCell(200, 25, "".$rep->company['coy_name'] ,0, 'L', 0, 2, 70,805, true);
// $rep->Text($ccol+80, $rep->company['coy_name'], $icol);
	$rep->Font('');
$rep->fontSize -= 8;
