...
$pref = get_company_prefs();
	...
	$cols = array(4, 50, 160, 220, 260, 320, 370, 460,460, 515);

	// $headers in doctext.inc
	$aligns = array('left',	'left',	'right', 'left','left', 'left', 'left', 'left', 'right', 'right');
     }
     else{
         	$cols = array(4, 50, 275, 275, 290, 350, 430, 460, 515);
...
//		        $rep->MultiCell(105,15,get_salesman_name($branch['salesman']),0,'C', 0, 2,145,270,true);
        ...
        $rep->MultiCell(100, 25, "Created by: ".get_user_name_70123($user) ,0, 'C', 0, 2, 400,775, true);
        $rep->MultiCell(100,12,get_designation_name($user),0,'L',0,0,490,775);
