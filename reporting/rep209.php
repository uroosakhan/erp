...
if($db_connections[$_SESSION["wa_current_user"]->company]["name"]=='RPL2'){
    ...
    $cols = array(0, 60, 240, 315, 360, 380,450 ,480,520);

    $aligns = array('left', 'left', 'left', 'left', 'left','center', 'right', 'right');
...
//            $rep->TextCol(7,8, price_format($TOTAL) , -2);
...
//                $rep->TextCol(6, 7,  $DisplayTax, -2);
    ...
    if ($myrow['tax_group_id'] == 1)
    {
        ...
        $rep->multicell(65, 5, price_format($grosstot), 0, 'R', 0, 0, 500, 680);
    ...
    else
    {
     ...
     $rep->multicell(85, 5, price_format($grosstot), 0, 'R', 0, 0,470, 680);
     $amount_in_words = _number_to_words($grosstot);
     $rep->multicell(400, 15, " " . $amount_in_words, 0, 'L', 0, 0, 125, 718);
    }
  ...
  //  $rep->setfontsize(+7);
    ...
    $rep->multicell(150,15,"_____________________",0,'L',0,0,335,760);
    $rep->multicell(150,15,"Authorised by",0,'L',0,0,360,775);
    $rep->multicell(150,15,"_____________________",0,'R',0,0,420,760);
