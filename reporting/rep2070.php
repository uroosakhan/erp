...
{
    $sql = "SELECT qty_invoiced, unit_price, delivery_date FROM ".TB_PREF."purch_order_details WHERE item_code = ".db_escape($item_code);
...
//    $cols = array(0, 30,100,115, 135, 165, 200, 230,270,310,360,420,490);
    $cols2 = array(0, 65,160,275, 325,390,450,520,570,630,700);
...
//
        ...
        $rep->MultiCell(170,10,"P.R.#"."                                ". $i,0,'L',0,0,47,75);
        $rep->MultiCell(300,10,"REMARKS :".$gst_nos['narrative'],0,'L',0,0,430,75);
        $rep->MultiCell(90,10,"DATE :".sql2date($gst_nos['application_date']),0,'L',0,0,430,90);
        $rep->MultiCell(90,10,"PARTY A/C.",0,'L',0,0,47,90);
        $rep->MultiCell(190,13,$rep->formData['supplier_id'],0,'L',0,0,150,90);
        $rep->MultiCell(90,10,"PARTY NAME:",0,'L',0,0,47,105);
        $rep->MultiCell(180,50,htmlspecialchars_decode($myrow['supp_name']),0,'L',0,0,150,105);
...
//            $rep->TextCol(9, 10,$sales_tax_amount2	, -2);
            $rep->TextCol(6, 7,	price_format($DisplayNet), -2);
            $purch_values =get_quantity_order($myrow2['item_code']);
            $rep->TextCol(7, 8,number_format2($purch_values['qty_invoiced'],get_qty_dec($myrow2['item_code']))	, -2);
            $rep->TextCol(8, 9,	number_format2($purch_values['unit_price'],get_qty_dec($myrow2['item_code'])), -2);
            $rep->TextCol(9, 10,	sql2date($purch_values['delivery_date']), -2);
            $rep->TextCol(10, 11,	$qoh, -2);
...
//                $rep->NewLine();
            ...
            $rep->NewLine();
            // $rep->multicell(42,297,"",1,'L',0,0,40,148);
            // $rep->multicell(126,297,"",1,'L',0,0,82,148);
...
// //
            // $rep->multicell(168,41,"",1,'L',0,0,40,133);
            // $rep->multicell(50,41,"",1,'L',0,0,208,133);
            // $rep->multicell(30,41,"",1,'L',0,0,258,133);
            // $rep->multicell(50,41,"",1,'L',0,0,288,133);
            // $rep->multicell(60,41,"",1,'L',0,0,338,133);
            // $rep->multicell(90,41,"",1,'L',0,0,398,133);
            // $rep->multicell(70,41,"",1,'L',0,0,488,133);
            // $rep->multicell(180,41,"",1,'L',0,0,558,133);
