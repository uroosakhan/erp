...
function print_invoices()
{
	...
	$cols = array(0, 30, 150, 180, 215, 260, 310,360,409, 465);
//	$cols1 = array(0, 30, 150, 180, 215, 260, 310,350,370, 465);
//
//	$this->headers = array(_("S.no"), _("Description"), _("Qty"), _("Rate"), _("Batch"),
//		_("Expiry"), _("Amount"), _("Special/Discount"), _("Distributor Discount"), _("Total Amount"));
...
//					display_error($myrow2['amount5']);
					...
					$rep->TextCol(4, 5,$batch['name']	, -2);
					$rep->TextCol(5, 6,$batch['exp_date']	, -2);
					$rep->TextCol(7, 8,	" ".$myrow2['amount5'], -2);
					$rep->TextCol(8, 9,	" ".$myrow2['amount6'], -2);
		...
		$rep->MultiCell(340, 150, "".$sales_order['h_text4'] , 0, 'L', 0, 2, 46,548, true);
		$rep->MultiCell(525, 25, "" , 1, 'L', 0, 2, 40,536, true);
		$rep->MultiCell(525, 25, "A/C.#".$sales_order['h_text3'] , 0, 'L', 0, 2, 100,538, true);
		$rep->MultiCell(210, 25, "" , 1, 'L', 0, 2, 186,536, true);
...
//		display_error($myrow["discount2"]);
		...
		$rep->TextCol(9, 10, abs($total_amount), -2);
		...
		if ($rep->formData['prepaid'])
			{
				$rep->NewLine();
				$rep->Font('bold');
				$rep->TextCol(2, 4, $rep->formData['prepaid']=='final' ? _("THIS INVOICE") : _("TOTAL"), - 2);
