...
//					$rep->TextCol(9, 10,	$DisplayDiscount, -2);
        ...
        $rep->multicell(150,35,"".$myrow["term_cond"],0,'L',0,0,100,480);
        ...
        if ($memo != "")
        {
            ...
            $rep->multicell(200,10,"TERMS AND CONDITIONS",0,'L',0,0,200,570);
            $rep->MultiCell(800,20,"".$memo ,0,'L',0,0,50,580);
...
//		$rep->MultiCell(770, 30, "________________________", 0, 'L', 0,1,100,650, true);
        $rep->MultiCell(770, 30, "BANKNAME :", 0, 'L', 0,1,40,650, true);
        $rep->MultiCell(770, 30, "SWIFT CODE  :", 0, 'L', 0,1,40,660, true);
        $rep->MultiCell(770, 30, "IBAN   :", 0, 'L', 0,1,40,670, true);
        $rep->MultiCell(770, 30, "ACCOUNT TITLE   :", 0, 'L', 0,1,40,680, true);
