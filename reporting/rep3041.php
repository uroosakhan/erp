<?php
$page_security = 'SA_SALESREP_ITEM';
// ----------------------------------------------------------------
// $ Revision:	2.0 $
// Creator:	Joe Hunt
// date_:	2005-05-19
...
function getTransactions($category, $location, $stock_id, $fromcust, $from, $to,$salesman)
{
	$from = date2sql($from);
	$to = date2sql($to);
	$sql = "SELECT ".TB_PREF."stock_master.category_id,
        ...
        if ($salesman != '')
			$sql .= " AND ".TB_PREF."salesman.salesman_code=".db_escape($salesman);
...
function print_inventory_sales()
{
	...
	if ($salesman == ALL_NUMERIC)
		$salesman = 0;

	if ($salesman == 0)
		$salesfolk = _('All Sales Man');
	else
		$salesfolk = get_salesman_name($salesman);
    ...
    $params =   array( 	0 => $comments,
    				    ...
    				    6 => array('text' => _('Sales Man'), 'from' => $salesfolk, 'to' => ''));
	...
	$res = getTransactions($category, $location, $item, $fromcust, $from, $to, $salesman);
