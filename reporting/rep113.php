...
function print_credits()
{
	...
	$rep->MultiCell(150, 10, "_____________________________",0, 'L', 0, 2, 40,800, true);
$rep->MultiCell(150, 10, "Prepared by:",0, 'C', 0, 2, 40,810, true);

$rep->MultiCell(150, 10, "__________________________",0, 'L', 0, 2, 435,800, true);
$rep->MultiCell(150, 10, "Approved By:",0, 'C', 0, 2, 435,810, true);
	if ($email == 0)
		$rep->End();
}
