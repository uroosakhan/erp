...
function print_invoices()
{
	...
	$cols = array(4, 60, 225, 300, 400, 450);
...
//			$rep->NewLine();
		...
		if($myrow['discount2']) {
            ...
            $rep->multicell(60,35,number_format2($tot_net - $myrow['discount2'],get_qty_dec($myrow2['stock_id'])),1,'R',0,0,505,451);
            $rep->NewLine();
		}
		else{
            $rep->multicell(60,35,number_format2($tot_net,get_qty_dec($myrow2['stock_id'])),1,'R',0,0,505,451);
...
//					$rep->TextCol(6, 7,	$DisplayTax, -2);
        ...
        $rep->multicell(60,35,number_format2($tot_balance,$dec),1,'R',0,0,505,486);
         $rep->font('b');
        $rep->multicell(200,10,"Previous Balance:",0,'L',0,0,344,115);
        ...
        $rep->setfontsize(12);
        $rep->multicell(160,40,$memo,0,'L',0,0,150,570);
        $rep->multicell(160,20,get_shipping_through($myrow['ship_via']),0,'L',0,0,152,532);
          
        $rep->multicell(170,20," ".get_user_name_1($prepared_by),0,'L',0,0,115,650);
            $rep->setfontsize(8);
    		$rep->NewLine();
