...
function print_invoices()
{
	...
	$cols = array(2, 60, 200, 365, 405, 465, 470, 515);

	// $headers in doctext.inc
	$aligns = array('center',	'left',	'right', 'right', 'right', 'right', 'right');
...
//                $item=get_item($myrow2['stk_code']);
			...
			{
				$rep->NewLine();
				$rep->MultiCell(300, 30, $memo, 0, 'L', 0,1,46,205, true);
				// $rep->TextColLines(1, 5, "", -2);
			}

   			$DisplaySubTot = number_format2($SubTotal,$dec);
		$total_discount += ($myrow["discount2"]);
	...
	$rep->MultiCell(770, 30, "__________________", 0, 'L', 0,1,449,750, true);
