...
function print_sales_orders()
{
	...
	$cols = array(4, 40, 100, 190, 300, 350);
	...
	for ($i = $from; $i <= $to; $i++)
	{
		...
		$items = $prices = array();
		//$sr_no = 0;
		$rep->MultiCell(180, 10,"Print Person Name:   ".$myrow['customer_ref'] , 0, 'L', 0, 2, 405,115, true);
		$rep->MultiCell(180, 10,"Period:        _____________________" , 0, 'L', 0, 2, 40,90, true);
		$rep->MultiCell(180, 10,"Category :   _____________________" , 0, 'L', 0, 2, 40,120, true);
