		...
		function setPageFormat($format, $orientation="P") {
			...
			if (is_string($format)) {
				...
				switch (strtoupper($format)){
					...
					//case 'A5': {$format = array(595.28,420.945); break;}
					case 'A5': {$format = array(425.28,570.945); break;}
					case 'A5_': {$format = array(595.28,570.945); break;}
					case 'A5_BNT': {$format = array(495.28,770.945); break;}
					...
					case 'BLABELSING': {$format = array(160,100.00); break;}
					case 'POS': {$format = array(240.6,842.00); break;}
					case 'POS3': {$format = array(200.6,842.00); break;}
					case 'POS4': {$format = array(200.6,842.00); break;}
					case 'SPOS': {$format = array(220.6,842.00); break;}
					case 'MBARCODE': {$format = array(344.00,72.00); break;}
					case 'A4_LOC': {$format = array(595.28,1520.89); break;}
				}
				$this->fwPt = $format[0];
				$this->fhPt = $format[1];
			}
