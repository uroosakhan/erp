...
//        $rep->Font();
        ...
        $rep->MultiCell(300,40," ".$order_no['term_cond'],0,'L', 0, 2,65,750,true);
        $total_price =0;
...
//                $rep->MultiCell(75 ,28 ,"".$discount,1,'L', 0, 2,489,617,true);
        ...
        $rep->Font('bold');
        $rep->MultiCell(130 ,28 ,"Grand Total"."     ".$grand_total,1,'L', 0, 2,435,617,true);
        $rep->Font('');
        $rep->Font('');
        $rep->fontSize -= 10;
