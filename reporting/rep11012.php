...
//                $item=get_item($myrow2['stk_code']);
        ...
        $rep->MultiCell(115, 15, "".$myrow['reference'], 0, 'L', 0, 2, 450,200, true);
                $rep->MultiCell(180, 15, "", 1, 'L', 0, 2, 385,200, true);
                        $rep->MultiCell(180, 15, "", 1, 'L', 0, 2, 385,230, true);
                        $rep->MultiCell(180, 15, "", 1, 'L', 0, 2, 385,245, true);
