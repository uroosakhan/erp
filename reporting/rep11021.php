...
function get_delivery_details($id)
{
    ...
    WHERE debtor_trans_no = ".db_escape($id)."
    ";
    $query= db_query($sql, "Cannot get dimensions");
    return $query;
...
function print_po()
{
    ...
    $cols = array(4, 30, 70, 270, 335,400,460);
...
//               $rep->TextCol(1, 2,	get_reference(ST_PURCHORDER,$myrow['purch_order_no']), -2);
                ...
                $rep->TextCol(2, 3,	$myrow2['description'], -2);
                 $rep->TextCollines(3, 4,	 $myrow2['quantity'], -2);
                $rep->NewLine(-1);
                 $rep->TextCollines(4, 5,	 $myrow2['text2'], -2);
                $rep->NewLine(-1);
