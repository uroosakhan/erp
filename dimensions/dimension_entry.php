...
if (isset($_POST['ADD_ITEM']) || isset($_POST['UPDATE_ITEM'])) 
{
	...
	if (can_process()) 
	{
		...
		if ($selected_id == -1) 
		{
			$id = add_dimension($_POST['ref'], $_POST['name'], $_POST['type_'], $_POST['date_'], $_POST['due_date'], $_POST['memo_'], $_POST['cust_name'], $_POST['sales_person'], $_POST['area'], $_POST['ref_1'], $_POST['ref_2'], $_POST['ref_3'], $_POST['division123'], $_POST['project123'], $_POST['prefix']);
		...
		else 
		{
			...
			update_dimension($selected_id, $_POST['name'], $_POST['type_'], $_POST['date_'], $_POST['due_date'], $_POST['memo_'], $_POST['cust_name'], $_POST['sales_person'], $_POST['area'], $_POST['ref_1'], $_POST['ref_2'], $_POST['ref_3'], $_POST['division123'], $_POST['project123'], $_POST['prefix']);
...
if ($selected_id != -1)
{
    ...
    $_POST['cust_name'] = $myrow["cust_name"];
    $_POST['sales_person'] = $myrow["sales_person"];
    $_POST['area'] = $myrow["area"];
    $_POST['ref_1'] = $myrow["ref_1"];
    $_POST['ref_2'] = $myrow["ref_2"];
    $_POST['ref_3'] = $myrow["ref_3"];
...
{
	$_POST['dimension_tags'] = array();
	ref_row(_("Project ID:"), 'ref', '', $Refs->get_next(ST_DIMENSION), false, ST_DIMENSION);
}
else{
    $_POST['dimension_tags'] = array();
...
if($db_connections[$_SESSION["wa_current_user"]->company]["name"]=='SE1')
{
text_row_ex(_("Project Description") . ":", 'name', 50, 75);

//$dim = get_company_pref('use_dimension');

  //  number_list_row(_("Type"), 'type_', null, 1, $dim,false,true);
    //display_error($_POST['type_']);
    //if($_POST['type_']==2)
    //{
     //   division_title_row(_("Division:"), 'division123', null,true);
    //}elseif ($_POST['type_']==3)
    //{

      //  project_title_row(_("Project:"), 'project123', null,true);
    //}


customer_list_row("Client", 'cust_name', null, false, false, false, false);

sales_persons_list_row("Sales Person", 'sales_person', null, false) ;

sales_areas_list_row("Area", 'area', null);

text_row_ex(_("Quotation Nos") . ":", 'ref_1', 50, 75);

text_row_ex(_("PO Nos") . ":", 'ref_2', 50, 75);

text_row_ex(_("Working Status") . ":", 'ref_3', 50, 75);
...
// customer_list_row("Customer", 'cust_name', null, false, false, false, false);
