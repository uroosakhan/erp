...
$supp_trans = new supp_trans_price_import(ST_SUPPINVOICE);

read_supp_invoice_price_import($trans_no, ST_SUPPCREDIT_IMPORT, $supp_trans);
...
$total_gl = display_gl_items_price_import($supp_trans, 2);
$total_grn = display_grn_items_price_import($supp_trans, 2);
