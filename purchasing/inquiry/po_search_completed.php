...
function trans_view($trans)
{
    ...
    if ($SysPrefs->show_doc_ref() == 0) {
        ...
        {
        return get_trans_view_str(ST_PURCHORDER, $trans["order_no"], get_reference(ST_PURCHORDER,$trans["order_no"]));
    }
...
if (isset($_POST['pr_number'])&& ($_POST['pr_number'] != ""))
{
...
if (isset($_POST['also_closed']))
{
    $also_closed = $_POST['also_closed'];
}
