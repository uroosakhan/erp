...
function commit_item_data($n)
{
	if (check_item_data($n))
	{
		$_SESSION['supp_trans']->add_grn_to_trans($n,
    		...
    		$_POST['std_cost_unit'.$n], "",$_POST['text1'.$n],$_POST['text2'.$n],$_POST['text3'.$n]
			,$_POST['text4'.$n],$_POST['text5'.$n],$_POST['text6'.$n],$_POST['text7'.$n],input_num('amount1'.$n),input_num('amount2'.$n),input_num('amount3'.$n)
			,input_num('amount4'.$n),input_num('amount5'.$n),input_num('amount6'.$n),$_POST['date1'.$n],$_POST['date2'.$n],$_POST['date3'.$n]
			,$_POST['combo1'.$n],$_POST['combo2'.$n],$_POST['combo3'.$n]
			,$_POST['combo4'.$n],$_POST['combo5'.$n],$_POST['combo6'.$n],$_POST['batch'.$n],$_POST['con_factor'.$n],$_POST['units_id'.$n]);
		reset_tax_input();
	}
}
