...
page(_($help_context = "Payroll Deduction"),true);

include($path_to_root . "/payroll/includes/db/payroll_deduction_db.inc");
...
$result = get_emp_deductions2($payroll_id);

start_form();
start_table(TABLESTYLE, "width=30%");
$th = array( _("Deduction"), _("Amount"));
...
while ($myrow = db_fetch($result)) 
{
	...
	label_cell(get_emp_deduction_name($myrow["deduct_id"]));
