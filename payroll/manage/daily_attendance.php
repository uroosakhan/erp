<?php
$page_security = 'SA_HUMAIN_DAILY_ATTEN';
$path_to_root = "../..";
...
if (isset($_POST['update']))
{
	...
	update_daily_attendance($selected_id, $_POST['employee_id'], $_POST['check_in'], $_POST['check_out'], $_POST['fiscal_year'], $_POST['division'], $_POST['project'], $_POST['location']);
//	$emp = get_employee_name( $_POST['employee_id']);
	$note = "Attendance  Has been Updated";
	display_notification($note);
	$Mode = 'RESET';
}
...
$th = array(_("Employee"), _("Check In"),_("Check Out"),/*_("Fiscal Year"),*/  "", "");
inactive_control_column($th);

table_header($th);
$k = 0;

$result = get_daily_att(check_value('show_inactive'));
...
dimensions_list_row(_("Divison"), 'division', $_POST['divisionoooo'], 'All division', "", false, 1,false);
pro_list_row(_("Project"), 'project',null, 'All Projects', "", false, 2,false,$_POST['division']);
loc_list_row(_("Location"), 'location',null, 'All Locations', "", false, 3,false,$_POST['project']);
