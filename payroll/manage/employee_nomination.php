...
page(_($help_context = "Employee Nomination"),true);
...
if ($Mode=='ADD_ITEM' || $Mode=='UPDATE_ITEM') 
{
	...
	if ($input_error != 1)
	{
    	...
    	if ($selected_id != -1) 
    	{
			update_employee_nomination($selected_id,$_POST['nominee_name'],$_POST['relation'],$_POST['age']
...
start_form();
$result = get_employee_nomination_all($_GET['id']);
...
{
 	if ($Mode == 'Edit') {
		$myrow = get_employee_nomination($selected_id);
