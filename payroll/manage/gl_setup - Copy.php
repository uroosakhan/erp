...
//include($path_to_root . "/payroll/includes/db/gl_setup_db.inc.inc");
//-------------------------------------------------------------------------------------------------
...
gl_all_accounts_list_row(_("GST WH Account:"), 'bank_charge_act', $_POST['bank_charge_act']);
...
gl_all_accounts_list_row(_("WHT:"), 'default_prompt_payment_act');
...
table_section_title(_("Cost Centre Defaults"));

text_row(_("Cost Centre Required By After:"), 'default_dim_required', $_POST['default_dim_required'], 6, 6, '', "", _("days"));
//---------------
...
gl_all_accounts_list_row(_("WHT:"), 'pyt_discount_act', $_POST['pyt_discount_act']);
