...
page(_($help_context = "Bulk Wise Gratuity Entry"), @$_REQUEST['popup'], false, "", $js);
...
{
	    $data = get_emp_by_department($emp_dept,'gratuity');
		...
		<td colspan='' class='tableheader'>&nbsp; Tax Installments &nbsp;</td>
		<td colspan='' class='tableheader'>&nbsp; Amount &nbsp;</td>
		<td colspan='' class='tableheader'>&nbsp; Taxable income &nbsp;</td>
		<td colspan='' class='tableheader'>&nbsp; Income Tax &nbsp;</td>
		<td colspan='' class='tableheader'>&nbsp; Payment Date &nbsp;</td>
		<td colspan='' class='tableheader'>&nbsp; Bank &nbsp;</td>
...
<!--		<td colspan='' class='tableheader'>&nbsp; GL Voucher &nbsp;</td>-->
		...
		<td colspan='' class='tableheader'>&nbsp; GL IT &nbsp;</td>
...
//			echo'<td>';
			text_cells(null, 'gl_it'.$a, null, 10, 10);
//			echo'</td>';
