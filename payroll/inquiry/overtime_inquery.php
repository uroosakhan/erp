...
function edit_link($row) 
{
  ...
  return pager_link( _("Edit"),
    "/payroll/manage/dayovertime.php?emp_dept=".$row['emp_dept'].'&date='.$row['date'], ICON_EDIT);
}

//------------------------------------------------------------------------------------------------
function get_sql_for_employee_inquiry($employee_id, $emp_dept, $emp_grade,$emp_desig,$datefrom,$dateto)
{
	$sql = "SELECT ".TB_PREF."employee.emp_name,".TB_PREF."grade.description As grade,".TB_PREF."desg.description As desination,".TB_PREF."dept.description, ".TB_PREF."overtime.date, ".TB_PREF."overtime.over_time,".TB_PREF."overtime.`id`,".TB_PREF."overtime.`emp_dept` FROM ".TB_PREF."overtime
INNER JOIN ".TB_PREF."employee ON ".TB_PREF."overtime.`employee_id` = ".TB_PREF."employee.`employee_id` 
INNER JOIN ".TB_PREF."dept ON ".TB_PREF."dept.`id` = ".TB_PREF."overtime.`emp_dept` 
...
WHERE ( ".TB_PREF."overtime.date >= '$datefrom'
AND ".TB_PREF."overtime.date <= '$dateto' )";
