...
function get_sql_for_employee_inquiry($emp_id, $emp_dept, $emp_grade,$emp_desig,$approve, $datefrom,$dateto)
{
	...
	$emp_desig=$_POST['emp_desig'];
	 ...
	 $sql = "SELECT ".TB_PREF."employee.emp_name,".TB_PREF."grade.description As grade,".TB_PREF."desg.description As desination,".TB_PREF."dept.description As department, ".TB_PREF."leave.`from_date` , ".TB_PREF."leave.`to_date` , ".TB_PREF."leave.`reason`,".TB_PREF."leave_type.description,".TB_PREF."leave.no_of_leave,IF(  `approve` =0,  'Unapprove',  'Approve' ) AS approve, ".TB_PREF."leave.`id` FROM ".TB_PREF."leave
...
/*	 $sql = "SELECT ".TB_PREF."employee.emp_name, ".TB_PREF."presence.date, ".TB_PREF."presence.present, IF(  `present` =0,  'No',  'Yes' ) AS present
...
$sql = get_sql_for_employee_inquiry($_POST['emp_id'],$_POST['emp_dept'],$_POST['emp_grade'],$_POST['emp_desig'],$_POST['approve'],sql2date($_POST['datefrom']),sql2date($_POST['dateto']));
 $cols = array(
			_("Employee Name"),
			_("Grade"),
			_("Desination"),
