...
<center>
        <td><a class="hvr-float-shadow" href="http://beta.erp30.com/portal.php"><i class="fa fa-dashboard " style="margin-right: 5px; font-size: large;">  </i> Fetch Data</a></td>
...
function edit_link($row) 
{
	if (@$_GET['popup'])
		//return '';
		display_error($row['dbname']);
	$modify = $row['user_id'];
  return pager_link( _("Edit"),
    "/admin/portal_user.php?comp_db=".$row['dbname'].'&user_id='.$modify, ICON_EDIT);
}
...
$sql = get_sql_for_employee_inquiry($_POST['comp_code'],$_POST['emp_dept'],$_POST['emp_grade'],$_POST['emp_desig'],date2sql($_POST['datefrom']),date2sql($_POST['dateto']));
 $cols = array(
	...
	array_append($cols, array(
		_("Change Password")=>array('insert'=>true, 'fun'=>'edit_link'),
